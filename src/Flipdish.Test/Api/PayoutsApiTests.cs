...
namespace Flipdish.Test
{
    ...
    public class PayoutsApiTests
    {
        ...
        public void GetPayoutSummariesTest()
        {
            ...
            //var response = instance.GetPayoutSummaries(appId, bankAccountId, payeeBankAccountDataId, startDate, endDate, status, payoutRequestIdsBankAccountIds, payoutRequestIdsStates);
        ...
        public void GetPayoutsTest()
        {
            ...
            //List<int?> payoutRequestIdsBankAccountIds = null;
            //List<string> payoutRequestIdsStates = null;
            //var response = instance.GetPayouts(appId, bankAccountId, payeeBankAccountDataId, startDate, endDate, status, page, limit, payoutRequestIdsBankAccountIds, payoutRequestIdsStates);
