...
namespace IO.Swagger.Test
{
    ...
    public class WebhooksApiTests
    {
        ...
        /// <summary>
        /// Test GetWebhookEventSample
        /// </summary>
        [Test]
        public void GetWebhookEventSampleTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string eventName = null;
            //string appId = null;
            ...
            //string version = null;
            //var response = instance.GetWebhookEventSample(eventName, appId, oauthAppId, webhookSubscriptionId, version);
            //Assert.IsInstanceOf<WebhookEventSample> (response, "response is WebhookEventSample");
        }
