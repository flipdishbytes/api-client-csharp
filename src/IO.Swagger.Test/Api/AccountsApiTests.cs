...
namespace IO.Swagger.Test
{
    ...
    public class AccountsApiTests
    {
        ...
        /// <summary>
        /// Test SendPinForPasswordReset
        /// </summary>
        [Test]
        public void SendPinForPasswordResetTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //RequestPasswordResetModel requestPasswordResetRequest = null;
            //var response = instance.SendPinForPasswordReset(requestPasswordResetRequest);
            //Assert.IsInstanceOf<RequestPasswordResetPinResponse> (response, "response is RequestPasswordResetPinResponse");
        }
