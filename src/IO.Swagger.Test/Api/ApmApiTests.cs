...
namespace IO.Swagger.Test
{
    ...
    public class ApmApiTests
    {
        ...
        /// </summary>
        [Test]
        public void GetApmStatusTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string appId = null;
            //var response = instance.GetApmStatus(appId);
            //Assert.IsInstanceOf<RestApiResultApmStatus> (response, "response is RestApiResultApmStatus");
        }
