...
namespace Flipdish.Api
{
    ...
    /// </summary>
    public interface IPendingMenuChangesApi : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class PendingMenuChangesApi : IPendingMenuChangesApi
    {
        private Flipdish.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="PendingMenuChangesApi"/> class.
        /// </summary>
        /// <returns></returns>
        public PendingMenuChangesApi(String basePath)
        {
        ...
        /// <returns></returns>
        public PendingMenuChangesApi(Flipdish.Client.Configuration configuration = null)
        {
        ...
        public ApiResponse< RestApiPaginationResultPendingMenuChanges > GetPendingMenuChangesWithHttpInfo (string appId, int? menuId = null, string catalogElementId = null, int? page = null, int? limit = null)
        {
            ...
            if (appId == null)
                throw new ApiException(400, "Missing required parameter 'appId' when calling PendingMenuChangesApi->GetPendingMenuChanges");

            var localVarPath = "/api/v1.0/{appId}/menus/pendingmenuchanges";
