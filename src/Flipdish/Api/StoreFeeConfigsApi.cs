...
namespace Flipdish.Api
{
    ...
    /// </summary>
    public interface IStoreFeeConfigsApi : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class StoreFeeConfigsApi : IStoreFeeConfigsApi
    {
        private Flipdish.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="StoreFeeConfigsApi"/> class.
        /// </summary>
        /// <returns></returns>
        public StoreFeeConfigsApi(String basePath)
        {
        ...
        /// <returns></returns>
        public StoreFeeConfigsApi(Flipdish.Client.Configuration configuration = null)
        {
        ...
        public ApiResponse< RestApiArrayResultProcessingFeeConfig > GetProcessingFeeConfigsByStoreIdWithHttpInfo (int? storeId, string appNameId = null)
        {
            ...
            if (storeId == null)
                throw new ApiException(400, "Missing required parameter 'storeId' when calling StoreFeeConfigsApi->GetProcessingFeeConfigsByStoreId");
        ...
        public ApiResponse< RestApiResultProcessingFeeConfig > GetProcessingFeeConfigsByStoreIdAndPaymentAccountTypeWithHttpInfo (int? storeId, string paymentAccountType, string appNameId = null)
        {
            // verify the required parameter 'storeId' is set
            if (storeId == null)
                throw new ApiException(400, "Missing required parameter 'storeId' when calling StoreFeeConfigsApi->GetProcessingFeeConfigsByStoreIdAndPaymentAccountType");
            // verify the required parameter 'paymentAccountType' is set
            if (paymentAccountType == null)
                throw new ApiException(400, "Missing required parameter 'paymentAccountType' when calling StoreFeeConfigsApi->GetProcessingFeeConfigsByStoreIdAndPaymentAccountType");
        ...
        public ApiResponse< StoreFeeConfig > GetStoreFeeConfigWithHttpInfo (int? storeId)
        {
            // verify the required parameter 'storeId' is set
            if (storeId == null)
                throw new ApiException(400, "Missing required parameter 'storeId' when calling StoreFeeConfigsApi->GetStoreFeeConfig");
