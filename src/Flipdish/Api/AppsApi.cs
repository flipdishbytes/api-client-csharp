...
namespace Flipdish.Api
{
    ...
    public partial class AppsApi : IAppsApi
    {
        ...
        public ApiResponse< RestApiResultAppConfigSalesChannel > EditAppConfigSalesChannelWithHttpInfo (string appId, AppConfigSalesChannel appConfigSalesChannel)
        {
            ...
            if (appId == null)
                throw new ApiException(400, "Missing required parameter 'appId' when calling AppsApi->EditAppConfigSalesChannel");
            // verify the required parameter 'appConfigSalesChannel' is set
            if (appConfigSalesChannel == null)
                throw new ApiException(400, "Missing required parameter 'appConfigSalesChannel' when calling AppsApi->EditAppConfigSalesChannel");

            var localVarPath = "/api/v1.0/apps/{appId}/config/saleschannel";
