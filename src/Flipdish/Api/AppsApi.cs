...
namespace Flipdish.Api
{
    ...
    public interface IAppsApi : IApiAccessor
    {
        ...
        /// <exception cref="Flipdish.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="appId"></param>
        /// <returns>AppSalesforceReferences</returns>
        ...
        /// <exception cref="Flipdish.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="appId"></param>
        /// <returns>ApiResponse of AppSalesforceReferences</returns>
        ApiResponse<AppSalesforceReferences> GetSalesforceReferencesWithHttpInfo (string appId);
        /// <summary>
        /// 
        /// </summary>
        /// <remarks>
        ...
        /// <exception cref="Flipdish.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="appId"></param>
        /// <param name="salesforceReferences"></param>
        /// <returns>RestApiStringResult</returns>
        ...
        /// <param name="salesforceReferences"></param>
        /// <returns>ApiResponse of RestApiStringResult</returns>
        ApiResponse<RestApiStringResult> SetSalesforceReferencesWithHttpInfo (string appId, AppSalesforceReferences salesforceReferences);
        /// <summary>
        /// 
        /// </summary>
        /// <remarks>
        ...
        /// <exception cref="Flipdish.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="appId"></param>
        /// <returns>Task of AppSalesforceReferences</returns>
        System.Threading.Tasks.Task<AppSalesforceReferences> GetSalesforceReferencesAsync (string appId);
        ...
        /// <exception cref="Flipdish.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="appId"></param>
        /// <returns>Task of ApiResponse (AppSalesforceReferences)</returns>
        System.Threading.Tasks.Task<ApiResponse<AppSalesforceReferences>> GetSalesforceReferencesAsyncWithHttpInfo (string appId);
        /// <summary>
        /// 
        /// </summary>
        /// <remarks>
        ...
        /// <param name="salesforceReferences"></param>
        /// <returns>Task of RestApiStringResult</returns>
        System.Threading.Tasks.Task<RestApiStringResult> SetSalesforceReferencesAsync (string appId, AppSalesforceReferences salesforceReferences);
        ...
        /// <param name="salesforceReferences"></param>
        /// <returns>Task of ApiResponse (RestApiStringResult)</returns>
        System.Threading.Tasks.Task<ApiResponse<RestApiStringResult>> SetSalesforceReferencesAsyncWithHttpInfo (string appId, AppSalesforceReferences salesforceReferences);
        /// <summary>
        /// 
        /// </summary>
        /// <remarks>
    ...
    public partial class AppsApi : IAppsApi
    {
        ...
        /// <param name="appId"></param>
        /// <returns>AppSalesforceReferences</returns>
        public AppSalesforceReferences GetSalesforceReferences (string appId)
        {
             ApiResponse<AppSalesforceReferences> localVarResponse = GetSalesforceReferencesWithHttpInfo(appId);
             return localVarResponse.Data;
        }
        ...
        /// <param name="appId"></param>
        /// <returns>ApiResponse of AppSalesforceReferences</returns>
        public ApiResponse< AppSalesforceReferences > GetSalesforceReferencesWithHttpInfo (string appId)
        {
            // verify the required parameter 'appId' is set
            if (appId == null)
                throw new ApiException(400, "Missing required parameter 'appId' when calling AppsApi->GetSalesforceReferences");

            var localVarPath = "./api/v1.0/apps/{appId}/salesforcereferences";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new List<KeyValuePair<String, String>>();
            var localVarHeaderParams = new Dictionary<String, String>(this.Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("GetSalesforceReferences", localVarResponse);
                if (exception != null) throw exception;
            }

            return new ApiResponse<AppSalesforceReferences>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Key, x => x.Value.ToString()),
                (AppSalesforceReferences) this.Configuration.ApiClient.Deserialize(localVarResponse, typeof(AppSalesforceReferences)));
        }
        ...
        /// <param name="appId"></param>
        /// <returns>Task of AppSalesforceReferences</returns>
        public async System.Threading.Tasks.Task<AppSalesforceReferences> GetSalesforceReferencesAsync (string appId)
        {
             ApiResponse<AppSalesforceReferences> localVarResponse = await GetSalesforceReferencesAsyncWithHttpInfo(appId);
             return localVarResponse.Data;
        ...
        /// <param name="appId"></param>
        /// <returns>Task of ApiResponse (AppSalesforceReferences)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<AppSalesforceReferences>> GetSalesforceReferencesAsyncWithHttpInfo (string appId)
        {
            // verify the required parameter 'appId' is set
            if (appId == null)
                throw new ApiException(400, "Missing required parameter 'appId' when calling AppsApi->GetSalesforceReferences");
        ...
        /// <param name="salesforceReferences"></param>
        /// <returns>RestApiStringResult</returns>
        public RestApiStringResult SetSalesforceReferences (string appId, AppSalesforceReferences salesforceReferences)
        {
             ApiResponse<RestApiStringResult> localVarResponse = SetSalesforceReferencesWithHttpInfo(appId, salesforceReferences);
             return localVarResponse.Data;
        }
        ...
        /// <param name="salesforceReferences"></param>
        /// <returns>ApiResponse of RestApiStringResult</returns>
        public ApiResponse< RestApiStringResult > SetSalesforceReferencesWithHttpInfo (string appId, AppSalesforceReferences salesforceReferences)
        {
            // verify the required parameter 'appId' is set
            if (appId == null)
                throw new ApiException(400, "Missing required parameter 'appId' when calling AppsApi->SetSalesforceReferences");
            // verify the required parameter 'salesforceReferences' is set
            if (salesforceReferences == null)
                throw new ApiException(400, "Missing required parameter 'salesforceReferences' when calling AppsApi->SetSalesforceReferences");
            ...
            if (appId != null) localVarPathParams.Add("appId", this.Configuration.ApiClient.ParameterToString(appId)); // path parameter
            if (salesforceReferences != null && salesforceReferences.GetType() != typeof(byte[]))
            {
                localVarPostBody = this.Configuration.ApiClient.Serialize(salesforceReferences); // http body (model) parameter
            }
            else
            {
                localVarPostBody = salesforceReferences; // byte array
            }
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("SetSalesforceReferences", localVarResponse);
                if (exception != null) throw exception;
            }
        ...
        /// <param name="salesforceReferences"></param>
        /// <returns>Task of RestApiStringResult</returns>
        public async System.Threading.Tasks.Task<RestApiStringResult> SetSalesforceReferencesAsync (string appId, AppSalesforceReferences salesforceReferences)
        {
             ApiResponse<RestApiStringResult> localVarResponse = await SetSalesforceReferencesAsyncWithHttpInfo(appId, salesforceReferences);
             return localVarResponse.Data;
        ...
        /// <param name="salesforceReferences"></param>
        /// <returns>Task of ApiResponse (RestApiStringResult)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<RestApiStringResult>> SetSalesforceReferencesAsyncWithHttpInfo (string appId, AppSalesforceReferences salesforceReferences)
        {
            // verify the required parameter 'appId' is set
            if (appId == null)
                throw new ApiException(400, "Missing required parameter 'appId' when calling AppsApi->SetSalesforceReferences");
