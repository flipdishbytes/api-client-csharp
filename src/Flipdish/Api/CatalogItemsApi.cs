...
namespace Flipdish.Api
{
    ...
    public interface ICatalogItemsApi : IApiAccessor
    {
        ...
        /// <param name="catalogItemId"></param>
        /// <returns>ApiResponse of Object(void)</returns>
        ApiResponse<Object> DeleteCatalogItemImageWithHttpInfo (string appId, string catalogItemId);
        /// <summary>
        ...
        /// <param name="appId"></param>
        /// <param name="catalogItemId"></param>
        /// <param name="image">Catalog Item image</param>
        ...
        /// <param name="catalogItemId"></param>
        /// <returns>Task of void</returns>
        System.Threading.Tasks.Task DeleteCatalogItemImageAsync (string appId, string catalogItemId);
        ...
        /// <param name="catalogItemId"></param>
        /// <returns>Task of ApiResponse</returns>
        System.Threading.Tasks.Task<ApiResponse<Object>> DeleteCatalogItemImageAsyncWithHttpInfo (string appId, string catalogItemId);
        /// <summary>
        /// Duplicate Catalog Item
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<RestApiStringResult> UploadCatalogItemImageAsync (string appId, string catalogItemId, System.IO.Stream image);
        ...
        System.Threading.Tasks.Task<ApiResponse<RestApiStringResult>> UploadCatalogItemImageAsyncWithHttpInfo (string appId, string catalogItemId, System.IO.Stream image);
    ...
    public partial class CatalogItemsApi : ICatalogItemsApi
    {
        ...
        /// <summary>
        /// Delete a CatalogItem Image [BETA - this endpoint is under development, do not use it in your production system]
        /// </summary>
        /// <exception cref="Flipdish.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="appId"></param>
        /// <param name="catalogItemId"></param>
        /// <returns></returns>
        public void DeleteCatalogItemImage (string appId, string catalogItemId)
        {
        ...
        /// <param name="catalogItemId"></param>
        /// <returns>ApiResponse of Object(void)</returns>
        public ApiResponse<Object> DeleteCatalogItemImageWithHttpInfo (string appId, string catalogItemId)
        {
            // verify the required parameter 'appId' is set
            if (appId == null)
                throw new ApiException(400, "Missing required parameter 'appId' when calling CatalogItemsApi->DeleteCatalogItemImage");
            // verify the required parameter 'catalogItemId' is set
            if (catalogItemId == null)
                throw new ApiException(400, "Missing required parameter 'catalogItemId' when calling CatalogItemsApi->DeleteCatalogItemImage");

            var localVarPath = "/api/v1.0/{appId}/catalog/items/{catalogItemId}/image";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new List<KeyValuePair<String, String>>();
            var localVarHeaderParams = new Dictionary<String, String>(this.Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("DeleteCatalogItemImage", localVarResponse);
                if (exception != null) throw exception;
            }
        ...
        /// <param name="catalogItemId"></param>
        /// <returns>Task of void</returns>
        public async System.Threading.Tasks.Task DeleteCatalogItemImageAsync (string appId, string catalogItemId)
        {
             await DeleteCatalogItemImageAsyncWithHttpInfo(appId, catalogItemId);
        ...
        /// <param name="catalogItemId"></param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<ApiResponse<Object>> DeleteCatalogItemImageAsyncWithHttpInfo (string appId, string catalogItemId)
        {
            // verify the required parameter 'appId' is set
            if (appId == null)
                throw new ApiException(400, "Missing required parameter 'appId' when calling CatalogItemsApi->DeleteCatalogItemImage");
        ...
        /// <summary>
        /// Upload a Catalog Item Image [BETA - this endpoint is under development, do not use it in your production system]
        /// </summary>
        /// <exception cref="Flipdish.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="appId"></param>
        /// <param name="catalogItemId"></param>
        /// <param name="image">Catalog Item image</param>
        /// <returns>RestApiStringResult</returns>
        public RestApiStringResult UploadCatalogItemImage (string appId, string catalogItemId, System.IO.Stream image)
        {
             ApiResponse<RestApiStringResult> localVarResponse = UploadCatalogItemImageWithHttpInfo(appId, catalogItemId, image);
             return localVarResponse.Data;
        }
        ...
        /// <param name="image">Catalog Item image</param>
        /// <returns>ApiResponse of RestApiStringResult</returns>
        public ApiResponse< RestApiStringResult > UploadCatalogItemImageWithHttpInfo (string appId, string catalogItemId, System.IO.Stream image)
        {
            // verify the required parameter 'appId' is set
            if (appId == null)
                throw new ApiException(400, "Missing required parameter 'appId' when calling CatalogItemsApi->UploadCatalogItemImage");
            // verify the required parameter 'catalogItemId' is set
            if (catalogItemId == null)
                throw new ApiException(400, "Missing required parameter 'catalogItemId' when calling CatalogItemsApi->UploadCatalogItemImage");
            // verify the required parameter 'image' is set
            if (image == null)
                throw new ApiException(400, "Missing required parameter 'image' when calling CatalogItemsApi->UploadCatalogItemImage");
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("UploadCatalogItemImage", localVarResponse);
                if (exception != null) throw exception;
            }
        ...
        /// <param name="image">Catalog Item image</param>
        /// <returns>Task of RestApiStringResult</returns>
        public async System.Threading.Tasks.Task<RestApiStringResult> UploadCatalogItemImageAsync (string appId, string catalogItemId, System.IO.Stream image)
        {
             ApiResponse<RestApiStringResult> localVarResponse = await UploadCatalogItemImageAsyncWithHttpInfo(appId, catalogItemId, image);
             return localVarResponse.Data;
        ...
        /// <param name="image">Catalog Item image</param>
        /// <returns>Task of ApiResponse (RestApiStringResult)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<RestApiStringResult>> UploadCatalogItemImageAsyncWithHttpInfo (string appId, string catalogItemId, System.IO.Stream image)
        {
            // verify the required parameter 'appId' is set
            if (appId == null)
                throw new ApiException(400, "Missing required parameter 'appId' when calling CatalogItemsApi->UploadCatalogItemImage");
