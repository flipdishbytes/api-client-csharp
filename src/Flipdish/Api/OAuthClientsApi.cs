...
namespace Flipdish.Api
{
    ...
    public interface IOAuthClientsApi : IApiAccessor
    {
        ...
        /// <param name="appId"></param>
        /// <returns>ApiResponse of Object(void)</returns>
        ApiResponse<Object> GetApplicationsWithHttpInfo (string appId);
        /// <summary>
        /// 
        /// </summary>
        /// <remarks>
        ...
        /// <param name="appId"></param>
        /// <returns>Task of void</returns>
        System.Threading.Tasks.Task GetApplicationsAsync (string appId);
        ...
        /// <param name="appId"></param>
        /// <returns>Task of ApiResponse</returns>
        System.Threading.Tasks.Task<ApiResponse<Object>> GetApplicationsAsyncWithHttpInfo (string appId);
        /// <summary>
        /// 
        /// </summary>
        /// <remarks>
    ...
    public partial class OAuthClientsApi : IOAuthClientsApi
    {
        ...
        /// <param name="appId"></param>
        /// <returns></returns>
        public void GetApplications (string appId)
        {
        ...
        /// <param name="appId"></param>
        /// <returns>ApiResponse of Object(void)</returns>
        public ApiResponse<Object> GetApplicationsWithHttpInfo (string appId)
        {
            // verify the required parameter 'appId' is set
            if (appId == null)
                throw new ApiException(400, "Missing required parameter 'appId' when calling OAuthClientsApi->GetApplications");
        ...
        /// <param name="appId"></param>
        /// <returns>Task of void</returns>
        public async System.Threading.Tasks.Task GetApplicationsAsync (string appId)
        {
             await GetApplicationsAsyncWithHttpInfo(appId);
        ...
        /// <param name="appId"></param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<ApiResponse<Object>> GetApplicationsAsyncWithHttpInfo (string appId)
        {
            // verify the required parameter 'appId' is set
            if (appId == null)
                throw new ApiException(400, "Missing required parameter 'appId' when calling OAuthClientsApi->GetApplications");
        ...
        public ApiResponse<Object> UpdateOAuthAppWithHttpInfo (string oauthAppId, OAuthApp oAuthApp, string appId)
        {
            // verify the required parameter 'oauthAppId' is set
            if (oauthAppId == null)
                throw new ApiException(400, "Missing required parameter 'oauthAppId' when calling OAuthClientsApi->UpdateOAuthApp");
            // verify the required parameter 'oAuthApp' is set
            if (oAuthApp == null)
                throw new ApiException(400, "Missing required parameter 'oAuthApp' when calling OAuthClientsApi->UpdateOAuthApp");
            // verify the required parameter 'appId' is set
            if (appId == null)
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("UpdateOAuthApp", localVarResponse);
                if (exception != null) throw exception;
            }
        ...
        {
             await UpdateOAuthAppAsyncWithHttpInfo(oauthAppId, oAuthApp, appId);
