...
namespace Flipdish.Api
{
    ...
    public interface IAppStoreDeveloperApi : IApiAccessor
    {
        ...
        ApiResponse<AppStoreApp> GetAppStoreAppWithHttpInfo (string oauthAppId, string appStoreAppId);
        /// <summary>
        ...
        System.Threading.Tasks.Task<AppStoreApp> GetAppStoreAppAsync (string oauthAppId, string appStoreAppId);
        ...
        System.Threading.Tasks.Task<ApiResponse<AppStoreApp>> GetAppStoreAppAsyncWithHttpInfo (string oauthAppId, string appStoreAppId);
        /// <summary>
        /// Update App store app
        /// </summary>
        /// <remarks>
    ...
    public partial class AppStoreDeveloperApi : IAppStoreDeveloperApi
    {
        ...
        /// <param name="appStoreAppId">App store app id</param>
        /// <returns>AppStoreApp</returns>
        public AppStoreApp GetAppStoreApp (string oauthAppId, string appStoreAppId)
        {
             ApiResponse<AppStoreApp> localVarResponse = GetAppStoreAppWithHttpInfo(oauthAppId, appStoreAppId);
             return localVarResponse.Data;
        }
        ...
        /// <param name="appStoreAppId">App store app id</param>
        /// <returns>ApiResponse of AppStoreApp</returns>
        public ApiResponse< AppStoreApp > GetAppStoreAppWithHttpInfo (string oauthAppId, string appStoreAppId)
        {
            // verify the required parameter 'oauthAppId' is set
            if (oauthAppId == null)
                throw new ApiException(400, "Missing required parameter 'oauthAppId' when calling AppStoreDeveloperApi->GetAppStoreApp");
            // verify the required parameter 'appStoreAppId' is set
            if (appStoreAppId == null)
                throw new ApiException(400, "Missing required parameter 'appStoreAppId' when calling AppStoreDeveloperApi->GetAppStoreApp");
        ...
        /// <param name="appStoreAppId">App store app id</param>
        /// <returns>Task of AppStoreApp</returns>
        public async System.Threading.Tasks.Task<AppStoreApp> GetAppStoreAppAsync (string oauthAppId, string appStoreAppId)
        {
             ApiResponse<AppStoreApp> localVarResponse = await GetAppStoreAppAsyncWithHttpInfo(oauthAppId, appStoreAppId);
             return localVarResponse.Data;
        ...
        /// <param name="appStoreAppId">App store app id</param>
        /// <returns>Task of ApiResponse (AppStoreApp)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<AppStoreApp>> GetAppStoreAppAsyncWithHttpInfo (string oauthAppId, string appStoreAppId)
        {
            // verify the required parameter 'oauthAppId' is set
            if (oauthAppId == null)
                throw new ApiException(400, "Missing required parameter 'oauthAppId' when calling AppStoreDeveloperApi->GetAppStoreApp");
