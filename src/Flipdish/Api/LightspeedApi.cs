...
namespace Flipdish.Api
{
    ...
    public partial class LightspeedApi : ILightspeedApi
    {
        ...
        /// <returns></returns>
        public LightspeedApi(Configuration configuration = null)
        {
        ...
        public ApiResponse< RestApiResultLightspeedSettings > LightspeedGetStoreSettingsWithHttpInfo (int? storeId)
        {
            ...
            return new ApiResponse<RestApiResultLightspeedSettings>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => x.Value.ToString()),
                (RestApiResultLightspeedSettings) Configuration.ApiClient.Deserialize(localVarResponse, typeof(RestApiResultLightspeedSettings)));
        }
        ...
        public ApiResponse< RestApiResultLightspeedSettings > LightspeedSaveStoreSettingsWithHttpInfo (int? storeId, LightspeedSettings lightspeedSettings)
        {
            ...
            {
                localVarPostBody = Configuration.ApiClient.Serialize(lightspeedSettings); // http body (model) parameter
            }
            else
            {
