...
namespace Flipdish.Api
{
    ...
    public partial class PaymentsApi : IPaymentsApi
    {
        ...
        /// <returns></returns>
        public PaymentsApi(Flipdish.Client.Configuration configuration = null)
        {
        ...
        {
             ApiResponse<RestApiResultOrderPaymentInformation> localVarResponse = GetOrderPaymentInformationWithHttpInfo(orderId);
        ...
        public ApiResponse< RestApiResultOrderPaymentInformation > GetOrderPaymentInformationWithHttpInfo (int? orderId)
        {
            ...
            {
                Exception exception = ExceptionFactory("GetOrderPaymentInformation", localVarResponse);
        ...
        {
             ApiResponse<RestApiResultOrderPaymentInformation> localVarResponse = await GetOrderPaymentInformationAsyncWithHttpInfo(orderId);
             return localVarResponse.Data;
