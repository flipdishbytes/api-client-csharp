...
namespace Flipdish.Api
{
    ...
    public partial class FilesApi : IFilesApi
    {
        ...
        /// <returns></returns>
        public FilesApi(Flipdish.Client.Configuration configuration = null)
        {
        ...
        public ApiResponse< string > DownloadFileWithHttpInfo (string appId, string fileId)
        {
            ...
            if (appId == null)
                throw new ApiException(400, "Missing required parameter 'appId' when calling FilesApi->DownloadFile");
