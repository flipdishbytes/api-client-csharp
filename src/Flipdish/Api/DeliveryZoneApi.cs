...
namespace Flipdish.Api
{
    ...
    public partial class DeliveryZoneApi : IDeliveryZoneApi
    {
        ...
        /// <returns></returns>
        public DeliveryZoneApi(Configuration configuration = null)
        {
        ...
        public ApiResponse< RestApiResultDeliveryZone > AddDeliveryZoneWithHttpInfo (int? storeId, DeliveryZoneBase deliveryZoneBase)
        {
            ...
            return new ApiResponse<RestApiResultDeliveryZone>(localVarStatusCode,
                ...
                (RestApiResultDeliveryZone) Configuration.ApiClient.Deserialize(localVarResponse, typeof(RestApiResultDeliveryZone)));
        }
        ...
        public ApiResponse< RestApiArrayResultDeliveryZone > GetDeliveryZonesWithHttpInfo (int? storeId)
        {
            ...
            return new ApiResponse<RestApiArrayResultDeliveryZone>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => x.Value.ToString()),
                (RestApiArrayResultDeliveryZone) Configuration.ApiClient.Deserialize(localVarResponse, typeof(RestApiArrayResultDeliveryZone)));
        }
        ...
        public ApiResponse<Object> RemoveDeliveryZoneWithHttpInfo (int? storeId, int? deliveryZoneId)
        {
            ...
            if (storeId != null) localVarPathParams.Add("storeId", Configuration.ApiClient.ParameterToString(storeId)); // path parameter
            if (deliveryZoneId != null) localVarPathParams.Add("deliveryZoneId", Configuration.ApiClient.ParameterToString(deliveryZoneId)); // path parameter
