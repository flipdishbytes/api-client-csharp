...
namespace Flipdish.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class StoreGroup :  IEquatable<StoreGroup>
    {
        /// <summary>
        ...
        public StoreGroup(int? storeGroupId = default(int?), double? generalRating = default(double?), int? generalRatingCount = default(int?), string deliveryMenuMessage = default(string), string pickupMenuMessage = default(string), List<string> brandIds = default(List<string>), string name = default(string), CurrencyEnum? currency = default(CurrencyEnum?))
        {
        ...
        {
            return this.Equals(input as StoreGroup);
        }

        /// <summary>
        /// Returns true if StoreGroup instances are equal
        /// </summary>
        /// <param name="input">Instance of StoreGroup to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StoreGroup input)
        {
            if (input == null)
                return false;
