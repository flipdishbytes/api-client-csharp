...
namespace Flipdish.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class HydraStoreAssignedEvent :  IEquatable<HydraStoreAssignedEvent>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="HydraStoreAssignedEvent" /> class.
        /// </summary>
        /// <param name="user">User who made the change.</param>
        /// <param name="storeIds">Store\\s to assign hydra to.</param>
        ...
        public HydraStoreAssignedEvent(UserEventInfo user = default(UserEventInfo), List<int?> storeIds = default(List<int?>), string eventName = default(string), Guid? flipdishEventId = default(Guid?), DateTime? createTime = default(DateTime?), int? position = default(int?), string appId = default(string), string orgId = default(string), string ipAddress = default(string), string activityId = default(string), string activityType = default(string))
        {
            this.User = user;
        ...
        /// </summary>
        /// <value>Store\\s to assign hydra to</value>
        ...
        {
            return this.Equals(input as HydraStoreAssignedEvent);
        }

        /// <summary>
        /// Returns true if HydraStoreAssignedEvent instances are equal
        /// </summary>
        /// <param name="input">Instance of HydraStoreAssignedEvent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(HydraStoreAssignedEvent input)
        {
            if (input == null)
                return false;
