...
namespace Flipdish.Model
{
    ...
    public partial class OrderRejectedEvent :  IEquatable<OrderRejectedEvent>, IValidatableObject
    {
        ...
        /// <param name="OrderRejectedTime">OrderRejectedTime.</param>
        ...
        public OrderRejectedEvent(string Description = default(string), DateTime? OrderRejectedTime = default(DateTime?), Order Order = default(Order), string EventName = default(string), Guid? FlipdishEventId = default(Guid?), DateTime? CreateTime = default(DateTime?), string Details = default(string), int? Position = default(int?))
        {
        ...
        /// <summary>
        /// Gets or Sets OrderRejectedTime
        /// </summary>
