...
namespace Flipdish.Model
{
    ...
    public partial class OrderRejectedEvent :  IEquatable<OrderRejectedEvent>
    {
        ...
        public OrderRejectedEvent(string eventName = default(string), string description = default(string), DateTime? orderRejectedTime = default(DateTime?), string reason = default(string), UserEventInfo user = default(UserEventInfo), Order order = default(Order), Guid? flipdishEventId = default(Guid?), DateTime? createTime = default(DateTime?), int? position = default(int?), string appId = default(string), string orgId = default(string), string ipAddress = default(string))
        {
