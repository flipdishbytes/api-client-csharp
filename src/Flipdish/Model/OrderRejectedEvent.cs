...
namespace Flipdish.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OrderRejectedEvent :  IEquatable<OrderRejectedEvent>
    {
        /// <summary>
        ...
        public OrderRejectedEvent(string eventName = default(string), string description = default(string), DateTime? orderRejectedTime = default(DateTime?), string reason = default(string), UserEventInfo user = default(UserEventInfo), Order order = default(Order), Guid? flipdishEventId = default(Guid?), DateTime? createTime = default(DateTime?), int? position = default(int?), string appId = default(string), string orgId = default(string), string ipAddress = default(string), string activityId = default(string), string activityType = default(string))
        {
