...
namespace Flipdish.Model
{
    ...
    public partial class OrderRejectedEvent :  IEquatable<OrderRejectedEvent>, IValidatableObject
    {
        ...
        public OrderRejectedEvent(string Description = default(string), DateTime? OrderRejectedTime = default(DateTime?), Order Order = default(Order), string EventName = default(string), Guid? FlipdishEventId = default(Guid?), DateTime? CreateTime = default(DateTime?), int? Position = default(int?))
        {
