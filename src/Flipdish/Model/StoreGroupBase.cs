...
namespace Flipdish.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class StoreGroupBase :  IEquatable<StoreGroupBase>, IValidatableObject
    {
        /// <summary>
        ...
        public StoreGroupBase(string Name = default(string), bool? IsEnabled = default(bool?), string UrlName = default(string), CurrencyEnum? Currency = default(CurrencyEnum?), string DeliveryMenuMessage = default(string), string CollectionMenuMessage = default(string))
        {
            this.Name = Name;
        ...
        {
            return this.Equals(input as StoreGroupBase);
        }

        /// <summary>
        /// Returns true if StoreGroupBase instances are equal
        /// </summary>
        /// <param name="input">Instance of StoreGroupBase to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StoreGroupBase input)
        {
            if (input == null)
                return false;
