...
namespace Flipdish.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class StoreGroupUpdatedEvent :  IEquatable<StoreGroupUpdatedEvent>
    {
        /// <summary>
        ...
        public StoreGroupUpdatedEvent(string eventName = default(string), int? storeGroupId = default(int?), UserEventInfo user = default(UserEventInfo), string description = default(string), StoreGroup storeGroup = default(StoreGroup), Guid? flipdishEventId = default(Guid?), DateTime? createTime = default(DateTime?), int? position = default(int?), string appId = default(string), string orgId = default(string), string ipAddress = default(string), string activityId = default(string), string activityType = default(string))
        {
        ...
        /// </summary>
        /// <value>User which updated this store group</value>
        ...
        {
            return this.Equals(input as StoreGroupUpdatedEvent);
        }

        /// <summary>
        /// Returns true if StoreGroupUpdatedEvent instances are equal
        /// </summary>
        /// <param name="input">Instance of StoreGroupUpdatedEvent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StoreGroupUpdatedEvent input)
        {
            if (input == null)
                return false;
