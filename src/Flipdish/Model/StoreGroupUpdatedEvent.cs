...
namespace Flipdish.Model
{
    ...
    public partial class StoreGroupUpdatedEvent :  IEquatable<StoreGroupUpdatedEvent>, IValidatableObject
    {
        ...
        public StoreGroupUpdatedEvent(int? storeGroupId = default(int?), UserEventInfo user = default(UserEventInfo), string description = default(string), StoreGroup storeGroup = default(StoreGroup), string eventName = default(string), Guid? flipdishEventId = default(Guid?), DateTime? createTime = default(DateTime?), int? position = default(int?))
        {
