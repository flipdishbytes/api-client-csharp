...
namespace Flipdish.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AppStoreSubscriptionChangeJobUpdatedEvent :  IEquatable<AppStoreSubscriptionChangeJobUpdatedEvent>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AppStoreSubscriptionChangeJobUpdatedEvent" /> class.
        /// </summary>
        ...
        public AppStoreSubscriptionChangeJobUpdatedEvent(string eventName = default(string), string appStoreAppId = default(string), string status = default(string), Guid? flipdishEventId = default(Guid?), DateTime? createTime = default(DateTime?), int? position = default(int?), string appId = default(string), string orgId = default(string), string ipAddress = default(string), string activityId = default(string), string activityType = default(string))
        {
        ...
        {
            return this.Equals(input as AppStoreSubscriptionChangeJobUpdatedEvent);
        }

        /// <summary>
        /// Returns true if AppStoreSubscriptionChangeJobUpdatedEvent instances are equal
        /// </summary>
        /// <param name="input">Instance of AppStoreSubscriptionChangeJobUpdatedEvent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AppStoreSubscriptionChangeJobUpdatedEvent input)
        {
            if (input == null)
                return false;
