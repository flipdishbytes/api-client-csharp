...
namespace Flipdish.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class UserDeletedEvent :  IEquatable<UserDeletedEvent>
    {
        /// <summary>
        ...
        public UserDeletedEvent(string eventName = default(string), string description = default(string), UserEventInfo user = default(UserEventInfo), Guid? flipdishEventId = default(Guid?), DateTime? createTime = default(DateTime?), int? position = default(int?), string appId = default(string), string orgId = default(string), string ipAddress = default(string), string activityId = default(string), string activityType = default(string))
        {
        ...
        {
            return this.Equals(input as UserDeletedEvent);
        }

        /// <summary>
        /// Returns true if UserDeletedEvent instances are equal
        /// </summary>
        /// <param name="input">Instance of UserDeletedEvent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UserDeletedEvent input)
        {
            if (input == null)
                return false;
