...
namespace Flipdish.Model
{
    ...
    public partial class NutritionInfoItemAddUpdateLabelModel :  IEquatable<NutritionInfoItemAddUpdateLabelModel>
    {
        ...
        {
            return this.Equals(input as NutritionInfoItemAddUpdateLabelModel);
        }

        /// <summary>
        /// Returns true if NutritionInfoItemAddUpdateLabelModel instances are equal
        /// </summary>
        /// <param name="input">Instance of NutritionInfoItemAddUpdateLabelModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NutritionInfoItemAddUpdateLabelModel input)
        {
            if (input == null)
                return false;
