...
namespace Flipdish.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CatalogItemArchivedEvent :  IEquatable<CatalogItemArchivedEvent>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CatalogItemArchivedEvent" /> class.
        /// </summary>
        ...
        public CatalogItemArchivedEvent(string eventName = default(string), string description = default(string), UserEventInfo user = default(UserEventInfo), CatalogItem catalogItem = default(CatalogItem), Guid? flipdishEventId = default(Guid?), DateTime? createTime = default(DateTime?), int? position = default(int?), string appId = default(string), string orgId = default(string), string ipAddress = default(string), string activityId = default(string), string activityType = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CatalogItemArchivedEvent {\n");
        ...
        {
            return this.Equals(input as CatalogItemArchivedEvent);
        }

        /// <summary>
        /// Returns true if CatalogItemArchivedEvent instances are equal
        /// </summary>
        /// <param name="input">Instance of CatalogItemArchivedEvent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CatalogItemArchivedEvent input)
        {
            if (input == null)
                return false;
