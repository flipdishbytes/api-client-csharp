...
namespace Flipdish.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OrderTerminalNotification :  IEquatable<OrderTerminalNotification>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OrderTerminalNotification" /> class.
        /// </summary>
        ...
        public OrderTerminalNotification(string eventName = default(string), string notification = default(string), Order order = default(Order), string terminalId = default(string), string description = default(string), Guid? flipdishEventId = default(Guid?), DateTime? createTime = default(DateTime?), int? position = default(int?), string appId = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class OrderTerminalNotification {\n");
        ...
        {
            return this.Equals(input as OrderTerminalNotification);
        }

        /// <summary>
        /// Returns true if OrderTerminalNotification instances are equal
        /// </summary>
        /// <param name="input">Instance of OrderTerminalNotification to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OrderTerminalNotification input)
        {
            if (input == null)
                return false;
