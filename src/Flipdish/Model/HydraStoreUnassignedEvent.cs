...
namespace Flipdish.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class HydraStoreUnassignedEvent :  IEquatable<HydraStoreUnassignedEvent>
    {
        /// <summary>
        ...
        public HydraStoreUnassignedEvent(UserEventInfo user = default(UserEventInfo), List<int?> storeIds = default(List<int?>), string eventName = default(string), Guid? flipdishEventId = default(Guid?), DateTime? createTime = default(DateTime?), int? position = default(int?), string appId = default(string), string orgId = default(string), string ipAddress = default(string), string activityId = default(string), string activityType = default(string))
        {
            this.User = user;
        ...
        /// </summary>
        /// <value>Store\\s to unassign hydra from</value>
        ...
        {
            return this.Equals(input as HydraStoreUnassignedEvent);
        }

        /// <summary>
        /// Returns true if HydraStoreUnassignedEvent instances are equal
        /// </summary>
        /// <param name="input">Instance of HydraStoreUnassignedEvent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(HydraStoreUnassignedEvent input)
        {
            if (input == null)
                return false;
