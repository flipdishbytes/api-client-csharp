...
namespace Flipdish.Model
{
    ...
    public partial class HydraStoreUnassignedEvent :  IEquatable<HydraStoreUnassignedEvent>
    {
        ...
        public HydraStoreUnassignedEvent(UserEventInfo user = default(UserEventInfo), List<int?> storeIds = default(List<int?>), string eventName = default(string), Guid? flipdishEventId = default(Guid?), DateTime? createTime = default(DateTime?), int? position = default(int?), string appId = default(string), string orgId = default(string), string ipAddress = default(string))
        {
            this.User = user;
