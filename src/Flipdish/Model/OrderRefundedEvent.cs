...
namespace Flipdish.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OrderRefundedEvent :  IEquatable<OrderRefundedEvent>
    {
        /// <summary>
        ...
        /// <param name="user">User who has refunded the order.</param>
        ...
        public OrderRefundedEvent(string eventName = default(string), double? refundedAmount = default(double?), string description = default(string), UserEventInfo user = default(UserEventInfo), Order order = default(Order), Guid? flipdishEventId = default(Guid?), DateTime? createTime = default(DateTime?), int? position = default(int?), string appId = default(string), string orgId = default(string), string ipAddress = default(string), string activityId = default(string), string activityType = default(string))
        {
        ...
        /// </summary>
        /// <value>User who has refunded the order</value>
