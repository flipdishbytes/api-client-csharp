...
namespace Flipdish.Model
{
    ...
    public partial class OrderRefundedEvent :  IEquatable<OrderRefundedEvent>, IValidatableObject
    {
        ...
        public OrderRefundedEvent(double? RefundedAmount = default(double?), string Description = default(string), Order Order = default(Order), string EventName = default(string), Guid? FlipdishEventId = default(Guid?), DateTime? CreateTime = default(DateTime?), string Details = default(string), int? Position = default(int?))
        {
