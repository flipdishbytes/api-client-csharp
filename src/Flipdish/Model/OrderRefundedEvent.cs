...
namespace Flipdish.Model
{
    ...
    public partial class OrderRefundedEvent :  IEquatable<OrderRefundedEvent>
    {
        ...
        public OrderRefundedEvent(string eventName = default(string), double? refundedAmount = default(double?), string description = default(string), UserEventInfo user = default(UserEventInfo), Order order = default(Order), Guid? flipdishEventId = default(Guid?), DateTime? createTime = default(DateTime?), int? position = default(int?), string appId = default(string), string orgId = default(string), string ipAddress = default(string))
        {
