...
namespace Flipdish.Model
{
    ...
    public partial class Invoice :  IEquatable<Invoice>
    {
        ...
        public Invoice(string invoiceId = default(string), string number = default(string), double? total = default(double?), CurrencyEnum currency = default(CurrencyEnum), StatusEnum status = default(StatusEnum), string subscriptionId = default(string), DateTime? dueDate = default(DateTime?), string pdfLink = default(string))
        {
            ...
            if (number == null)
            {
                throw new InvalidDataException("number is a required property for Invoice and cannot be null");
            }
            else
            {
                this.Number = number;
            ...
            if (pdfLink == null)
            {
                throw new InvalidDataException("pdfLink is a required property for Invoice and cannot be null");
            }
            else
            {
