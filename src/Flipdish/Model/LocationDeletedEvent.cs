...
namespace Flipdish.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class LocationDeletedEvent :  IEquatable<LocationDeletedEvent>, IValidatableObject
    {
        /// <summary>
        ...
        public LocationDeletedEvent(int? locationId = default(int?), string locationName = default(string), int? displayOrder = default(int?), string externalLocationId = default(string), int? locationAreaId = default(int?), string eventName = default(string), Guid? flipdishEventId = default(Guid?), DateTime? createTime = default(DateTime?), int? position = default(int?), string appId = default(string), string ipAddress = default(string))
        {
