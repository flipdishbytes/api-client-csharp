...
namespace Flipdish.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class LocationDeletedEvent :  IEquatable<LocationDeletedEvent>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LocationDeletedEvent" /> class.
        /// </summary>
        ...
        public LocationDeletedEvent(int? locationId = default(int?), string locationName = default(string), int? displayOrder = default(int?), string externalLocationId = default(string), int? locationAreaId = default(int?), string eventName = default(string), Guid? flipdishEventId = default(Guid?), DateTime? createTime = default(DateTime?), int? position = default(int?), string appId = default(string), string orgId = default(string), string ipAddress = default(string), string activityId = default(string), string activityType = default(string))
        {
        ...
        {
            return this.Equals(input as LocationDeletedEvent);
        }

        /// <summary>
        /// Returns true if LocationDeletedEvent instances are equal
        /// </summary>
        /// <param name="input">Instance of LocationDeletedEvent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LocationDeletedEvent input)
        {
            if (input == null)
                return false;
