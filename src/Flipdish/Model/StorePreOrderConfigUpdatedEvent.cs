...
namespace Flipdish.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class StorePreOrderConfigUpdatedEvent :  IEquatable<StorePreOrderConfigUpdatedEvent>
    {
        /// <summary>
        ...
        {
            return this.Equals(input as StorePreOrderConfigUpdatedEvent);
        }

        /// <summary>
        /// Returns true if StorePreOrderConfigUpdatedEvent instances are equal
        /// </summary>
        /// <param name="input">Instance of StorePreOrderConfigUpdatedEvent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StorePreOrderConfigUpdatedEvent input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.PreOrderConfig == input.PreOrderConfig ||
                    (this.PreOrderConfig != null &&
