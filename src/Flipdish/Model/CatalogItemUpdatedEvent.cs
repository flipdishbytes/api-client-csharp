...
namespace Flipdish.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CatalogItemUpdatedEvent :  IEquatable<CatalogItemUpdatedEvent>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CatalogItemUpdatedEvent" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as CatalogItemUpdatedEvent);
        }

        /// <summary>
        /// Returns true if CatalogItemUpdatedEvent instances are equal
        /// </summary>
        /// <param name="input">Instance of CatalogItemUpdatedEvent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CatalogItemUpdatedEvent input)
        {
            if (input == null)
                return false;
