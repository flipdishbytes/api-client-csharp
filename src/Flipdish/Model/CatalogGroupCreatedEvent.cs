...
namespace Flipdish.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CatalogGroupCreatedEvent :  IEquatable<CatalogGroupCreatedEvent>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CatalogGroupCreatedEvent" /> class.
        /// </summary>
        ...
        public CatalogGroupCreatedEvent(string eventName = default(string), string description = default(string), UserEventInfo user = default(UserEventInfo), Group group = default(Group), Guid? flipdishEventId = default(Guid?), DateTime? createTime = default(DateTime?), int? position = default(int?), string appId = default(string), string orgId = default(string), string ipAddress = default(string), string activityId = default(string), string activityType = default(string))
        {
        ...
        {
            return this.Equals(input as CatalogGroupCreatedEvent);
        }

        /// <summary>
        /// Returns true if CatalogGroupCreatedEvent instances are equal
        /// </summary>
        /// <param name="input">Instance of CatalogGroupCreatedEvent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CatalogGroupCreatedEvent input)
        {
            if (input == null)
                return false;
