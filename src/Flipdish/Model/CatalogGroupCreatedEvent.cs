...
namespace Flipdish.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CatalogGroupCreatedEvent :  IEquatable<CatalogGroupCreatedEvent>, IValidatableObject
    {
        /// <summary>
        ...
        public CatalogGroupCreatedEvent(string eventName = default(string), string description = default(string), UserEventInfo user = default(UserEventInfo), CatalogGroup catalogGroup = default(CatalogGroup), Guid? flipdishEventId = default(Guid?), DateTime? createTime = default(DateTime?), int? position = default(int?), string appId = default(string), string ipAddress = default(string))
        {
