...
{
    /// <summary>
    /// FlipdishPublicModelsV1Metadata
    /// </summary>
    [DataContract]
    public partial class FlipdishPublicModelsV1Metadata :  IEquatable<FlipdishPublicModelsV1Metadata>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FlipdishPublicModelsV1Metadata" /> class.
        /// </summary>
        /// <param name="Key">Key.</param>
        /// <param name="Value">Value.</param>
        public FlipdishPublicModelsV1Metadata(string Key = default(string), string Value = default(string))
        {
            this.Key = Key;
            this.Value = Value;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class FlipdishPublicModelsV1Metadata {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as FlipdishPublicModelsV1Metadata);
        }

        /// <summary>
        /// Returns true if FlipdishPublicModelsV1Metadata instances are equal
        /// </summary>
        /// <param name="other">Instance of FlipdishPublicModelsV1Metadata to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FlipdishPublicModelsV1Metadata other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
