...
namespace Flipdish.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class BusinessHoursOverrideBase :  IEquatable<BusinessHoursOverrideBase>, IValidatableObject
    {
        /// <summary>
        /// Delivery or Pickup
        /// </summary>
        ...
        protected BusinessHoursOverrideBase() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="BusinessHoursOverrideBase" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as BusinessHoursOverrideBase);
        }

        /// <summary>
        /// Returns true if BusinessHoursOverrideBase instances are equal
        /// </summary>
        /// <param name="input">Instance of BusinessHoursOverrideBase to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BusinessHoursOverrideBase input)
        {
            if (input == null)
                return false;
