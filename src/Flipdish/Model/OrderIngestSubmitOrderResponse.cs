...
namespace Flipdish.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OrderIngestSubmitOrderResponse :  IEquatable<OrderIngestSubmitOrderResponse>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="OrderIngestSubmitOrderResponse" /> class.
        /// </summary>
        ...
        public OrderIngestSubmitOrderResponse(int? orderId = default(int?), string receiptUrl = default(string), CurrencyCodeEnum? currencyCode = default(CurrencyCodeEnum?), Price totalPrice = default(Price), Price deliveryFee = default(Price), DateTime? estimatedDeliveryTime = default(DateTime?), string channelOrderId = default(string))
        {
        ...
        {
            return this.Equals(input as OrderIngestSubmitOrderResponse);
        }

        /// <summary>
        /// Returns true if OrderIngestSubmitOrderResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of OrderIngestSubmitOrderResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OrderIngestSubmitOrderResponse input)
        {
            if (input == null)
                return false;
