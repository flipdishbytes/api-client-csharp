...
namespace Flipdish.Model
{
    ...
    public partial class CatalogGroup :  IEquatable<CatalogGroup>, IValidatableObject
    {
        ...
        public CatalogGroup(string catalogGroupId = default(string), string catalogItemId = default(string), bool? isArchived = default(bool?), int? minSelectCount = default(int?), int? maxSelectCount = default(int?), List<CatalogItemReference> items = default(List<CatalogItemReference>), List<Metafield> metafields = default(List<Metafield>), GroupTypeEnum groupType = default(GroupTypeEnum), string sku = default(string), string name = default(string), bool? autogenerateDisplayText = default(bool?), string imageFileName = default(string))
        {
