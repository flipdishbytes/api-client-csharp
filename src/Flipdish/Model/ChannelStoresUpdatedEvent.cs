...
namespace Flipdish.Model
{
    ...
    public partial class ChannelStoresUpdatedEvent :  IEquatable<ChannelStoresUpdatedEvent>
    {
        ...
        public ChannelStoresUpdatedEvent(string eventName = default(string), int? channelId = default(int?), List<int?> storeIds = default(List<int?>), UserEventInfo user = default(UserEventInfo), Guid? flipdishEventId = default(Guid?), DateTime? createTime = default(DateTime?), int? position = default(int?), string appId = default(string), string orgId = default(string), string ipAddress = default(string), string activityId = default(string), string activityType = default(string))
        {
