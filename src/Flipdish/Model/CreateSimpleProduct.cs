...
namespace Flipdish.Model
{
    ...
    public partial class CreateSimpleProduct : CreateProduct,  IEquatable<CreateSimpleProduct>, IValidatableObject
    {
        ...
        public CreateSimpleProduct(ProductTypeEnum? productType = default(ProductTypeEnum?), string sku = default(string), string name = default(string), string description = default(string), double? price = default(double?), ProductTypeEnum productType = "CreateSimpleProduct") : base(sku, name, description, price, productType)
        {
