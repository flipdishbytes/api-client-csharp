...
namespace Flipdish.Model
{
    ...
    public partial class MenuCheckpointCreatedEvent :  IEquatable<MenuCheckpointCreatedEvent>, IValidatableObject
    {
        ...
        public MenuCheckpointCreatedEvent(string description = default(string), UserEventInfo user = default(UserEventInfo), Menu menu = default(Menu), int? menuId = default(int?), string eventName = default(string), Guid? flipdishEventId = default(Guid?), DateTime? createTime = default(DateTime?), int? position = default(int?), string appId = default(string))
        {
