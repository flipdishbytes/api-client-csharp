...
namespace Flipdish.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class MenuCheckpointCreatedEvent :  IEquatable<MenuCheckpointCreatedEvent>
    {
        /// <summary>
        ...
        public MenuCheckpointCreatedEvent(string description = default(string), UserEventInfo user = default(UserEventInfo), Menu menu = default(Menu), int? menuId = default(int?), string eventName = default(string), Guid? flipdishEventId = default(Guid?), DateTime? createTime = default(DateTime?), int? position = default(int?), string appId = default(string), string orgId = default(string), string ipAddress = default(string), string activityId = default(string), string activityType = default(string))
        {
