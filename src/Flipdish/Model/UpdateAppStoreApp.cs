...
namespace Flipdish.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class UpdateAppStoreApp :  IEquatable<UpdateAppStoreApp>, IValidatableObject
    {
        /// <summary>
        ...
        public UpdateAppStoreApp(ConfigurationTypeEnum configurationType = default(ConfigurationTypeEnum), StoreSelectorTypeEnum storeSelectorType = default(StoreSelectorTypeEnum), List<FieldGroup> fieldGroups = default(List<FieldGroup>), string setupInstructions = default(string), string externalSetupLink = default(string), string oAuthAppId = default(string), TeammateAppAccessLevelEnum? teammateAppAccessLevel = default(TeammateAppAccessLevelEnum?), PermissionsTypeEnum permissionsType = default(PermissionsTypeEnum), string name = default(string), string description = default(string), bool? isEnabled = default(bool?), List<string> tags = default(List<string>), List<string> regions = default(List<string>), string developerName = default(string))
        {
            ...
            if (oAuthAppId == null)
            {
                throw new InvalidDataException("oAuthAppId is a required property for UpdateAppStoreApp and cannot be null");
            }
            else
            {
            ...
            if (tags == null)
            {
                throw new InvalidDataException("tags is a required property for UpdateAppStoreApp and cannot be null");
            }
            else
            {
                this.Tags = tags;
            ...
            if (regions == null)
            {
                throw new InvalidDataException("regions is a required property for UpdateAppStoreApp and cannot be null");
            }
            else
            {
