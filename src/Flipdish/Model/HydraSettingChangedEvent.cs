...
namespace Flipdish.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class HydraSettingChangedEvent :  IEquatable<HydraSettingChangedEvent>
    {
        /// <summary>
        ...
        public HydraSettingChangedEvent(UserEventInfo user = default(UserEventInfo), HydraConfig hydraConfig = default(HydraConfig), string eventName = default(string), Guid? flipdishEventId = default(Guid?), DateTime? createTime = default(DateTime?), int? position = default(int?), string appId = default(string), string orgId = default(string), string ipAddress = default(string), string activityId = default(string), string activityType = default(string))
        {
            this.User = user;
        ...
        /// Hydra configuration
        /// </summary>
        /// <value>Hydra configuration</value>
        [DataMember(Name="HydraConfig", EmitDefaultValue=false)]
        public HydraConfig HydraConfig { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  HydraConfig: ").Append(HydraConfig).Append("\n");
        ...
        {
            return this.Equals(input as HydraSettingChangedEvent);
        }

        /// <summary>
        /// Returns true if HydraSettingChangedEvent instances are equal
        /// </summary>
        /// <param name="input">Instance of HydraSettingChangedEvent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(HydraSettingChangedEvent input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.HydraConfig == input.HydraConfig ||
                    (this.HydraConfig != null &&
                    this.HydraConfig.Equals(input.HydraConfig))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.HydraConfig != null)
                    hashCode = hashCode * 59 + this.HydraConfig.GetHashCode();
