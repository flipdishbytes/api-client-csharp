...
namespace Flipdish.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class StoreGroupDeletedEvent :  IEquatable<StoreGroupDeletedEvent>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="StoreGroupDeletedEvent" /> class.
        /// </summary>
        /// <param name="eventName">The event name.</param>
        /// <param name="storeGroupId">Store Group Id.</param>
        /// <param name="user">User which deleted this store group.</param>
        /// <param name="description">Description.</param>
        /// <param name="storeGroup">Deleted store group.</param>
        ...
        public StoreGroupDeletedEvent(string eventName = default(string), int? storeGroupId = default(int?), UserEventInfo user = default(UserEventInfo), string description = default(string), StoreGroup storeGroup = default(StoreGroup), Guid? flipdishEventId = default(Guid?), DateTime? createTime = default(DateTime?), int? position = default(int?), string appId = default(string), string orgId = default(string), string ipAddress = default(string), string activityId = default(string), string activityType = default(string))
        {
        ...
        /// </summary>
        /// <value>User which deleted this store group</value>
        ...
        /// Deleted store group
        /// </summary>
        /// <value>Deleted store group</value>
        ...
        {
            return this.Equals(input as StoreGroupDeletedEvent);
        }

        /// <summary>
        /// Returns true if StoreGroupDeletedEvent instances are equal
        /// </summary>
        /// <param name="input">Instance of StoreGroupDeletedEvent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StoreGroupDeletedEvent input)
        {
            if (input == null)
                return false;
