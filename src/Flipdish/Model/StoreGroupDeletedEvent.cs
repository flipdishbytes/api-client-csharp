...
namespace Flipdish.Model
{
    ...
    public partial class StoreGroupDeletedEvent :  IEquatable<StoreGroupDeletedEvent>
    {
        ...
        public StoreGroupDeletedEvent(string eventName = default(string), int? storeGroupId = default(int?), UserEventInfo user = default(UserEventInfo), string description = default(string), StoreGroup storeGroup = default(StoreGroup), Guid? flipdishEventId = default(Guid?), DateTime? createTime = default(DateTime?), int? position = default(int?), string appId = default(string), string orgId = default(string), string ipAddress = default(string))
        {
