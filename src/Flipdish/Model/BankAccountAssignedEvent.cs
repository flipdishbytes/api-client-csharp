...
namespace Flipdish.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class BankAccountAssignedEvent :  IEquatable<BankAccountAssignedEvent>
    {
        /// <summary>
        ...
        public BankAccountAssignedEvent(string orgId = default(string), BankAccount bankAccount = default(BankAccount), string description = default(string), UserEventInfo user = default(UserEventInfo), string eventName = default(string), Guid? flipdishEventId = default(Guid?), DateTime? createTime = default(DateTime?), int? position = default(int?), string appId = default(string), string ipAddress = default(string), string activityId = default(string), string activityType = default(string))
        {
            this.OrgId = orgId;
        ...
        /// </summary>
        /// <value>The assigned bank account</value>
        ...
        {
            return this.Equals(input as BankAccountAssignedEvent);
        }

        /// <summary>
        /// Returns true if BankAccountAssignedEvent instances are equal
        /// </summary>
        /// <param name="input">Instance of BankAccountAssignedEvent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BankAccountAssignedEvent input)
        {
            if (input == null)
                return false;
