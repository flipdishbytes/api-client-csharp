...
namespace Flipdish.Model
{
    ...
    public partial class MenuCreatedEvent :  IEquatable<MenuCreatedEvent>, IValidatableObject
    {
        ...
        public MenuCreatedEvent(string EventName = default(string), string Description = default(string), UserEventInfo User = default(UserEventInfo), Menu Menu = default(Menu), Guid? FlipdishEventId = default(Guid?), DateTime? CreateTime = default(DateTime?), int? Position = default(int?))
        {
