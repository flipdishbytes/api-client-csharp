...
namespace Flipdish.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AppStoreApp :  IEquatable<AppStoreApp>
    {
        /// <summary>
        ...
        public AppStoreApp(string id = default(string), bool? _internal = default(bool?), VerificationStatusEnum verificationStatus = default(VerificationStatusEnum), string logo = default(string), string oAuthAppId = default(string), string details = default(string), ConfigurationTypeEnum configurationType = default(ConfigurationTypeEnum), StoreSelectorTypeEnum storeSelectorType = default(StoreSelectorTypeEnum), List<FieldGroup> fieldGroups = default(List<FieldGroup>), string setupInstructions = default(string), string externalSetupLink = default(string), TeammateAppAccessLevelEnum? teammateAppAccessLevel = default(TeammateAppAccessLevelEnum?), PermissionsTypeEnum permissionsType = default(PermissionsTypeEnum), AppStoreAppSupportInfo support = default(AppStoreAppSupportInfo), string externalFunctionActionUrl = default(string), string externalFunctionSignatureKey = default(string), string name = default(string), string description = default(string), bool? isEnabled = default(bool?), List<CategoriesEnum> categories = default(List<CategoriesEnum>), List<CountriesEnum> countries = default(List<CountriesEnum>), string developerName = default(string))
        {
            ...
            if (_internal == null)
            {
                throw new InvalidDataException("_internal is a required property for AppStoreApp and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("verificationStatus is a required property for AppStoreApp and cannot be null");
            }
            else
            {
            ...
            if (oAuthAppId == null)
            {
                throw new InvalidDataException("oAuthAppId is a required property for AppStoreApp and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("configurationType is a required property for AppStoreApp and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("storeSelectorType is a required property for AppStoreApp and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("permissionsType is a required property for AppStoreApp and cannot be null");
            }
            else
            {
            ...
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for AppStoreApp and cannot be null");
            }
            else
            {
                this.Name = name;
            ...
            if (description == null)
            {
                throw new InvalidDataException("description is a required property for AppStoreApp and cannot be null");
            }
            else
            {
            ...
            if (categories == null)
            {
                throw new InvalidDataException("categories is a required property for AppStoreApp and cannot be null");
            }
            else
            {
            ...
            if (countries == null)
            {
                throw new InvalidDataException("countries is a required property for AppStoreApp and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as AppStoreApp);
        }

        /// <summary>
        /// Returns true if AppStoreApp instances are equal
        /// </summary>
        /// <param name="input">Instance of AppStoreApp to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AppStoreApp input)
        {
            if (input == null)
                return false;
