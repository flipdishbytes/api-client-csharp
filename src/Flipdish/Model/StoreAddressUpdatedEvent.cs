...
namespace Flipdish.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class StoreAddressUpdatedEvent :  IEquatable<StoreAddressUpdatedEvent>
    {
        /// <summary>
        ...
        public StoreAddressUpdatedEvent(string eventName = default(string), string orgId = default(string), int? storeId = default(int?), int? storeGroupId = default(int?), UserEventInfo user = default(UserEventInfo), string description = default(string), StoreAddress storeAddress = default(StoreAddress), Guid? flipdishEventId = default(Guid?), DateTime? createTime = default(DateTime?), int? position = default(int?), string appId = default(string), string ipAddress = default(string), string activityId = default(string), string activityType = default(string))
        {
