...
namespace Flipdish.Model
{
    ...
    public partial class MenuUploadedEvent :  IEquatable<MenuUploadedEvent>, IValidatableObject
    {
        ...
        public MenuUploadedEvent(string eventName = default(string), string description = default(string), UserEventInfo user = default(UserEventInfo), Menu menu = default(Menu), Guid? flipdishEventId = default(Guid?), DateTime? createTime = default(DateTime?), int? position = default(int?), string appId = default(string))
        {
