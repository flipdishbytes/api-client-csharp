...
namespace Flipdish.Model
{
    ...
    public partial class VoucherAppliedEvent :  IEquatable<VoucherAppliedEvent>
    {
        ...
        public VoucherAppliedEvent(int? voucherId = default(int?), string eventName = default(string), int? orderId = default(int?), Guid? flipdishEventId = default(Guid?), DateTime? createTime = default(DateTime?), int? position = default(int?), string appId = default(string), string orgId = default(string), string ipAddress = default(string))
        {
