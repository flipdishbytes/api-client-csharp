...
namespace Flipdish.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class StoreBusinessHoursOverrideCreatedEvent :  IEquatable<StoreBusinessHoursOverrideCreatedEvent>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="StoreBusinessHoursOverrideCreatedEvent" /> class.
        /// </summary>
        ...
        /// </summary>
        /// <value>Business Hours Override</value>
        [DataMember(Name="BusinessHoursOverride", EmitDefaultValue=false)]
        public BusinessHoursOverride BusinessHoursOverride { get; set; }
        ...
        {
            return this.Equals(input as StoreBusinessHoursOverrideCreatedEvent);
        }

        /// <summary>
        /// Returns true if StoreBusinessHoursOverrideCreatedEvent instances are equal
        /// </summary>
        /// <param name="input">Instance of StoreBusinessHoursOverrideCreatedEvent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StoreBusinessHoursOverrideCreatedEvent input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.BusinessHoursOverride == input.BusinessHoursOverride ||
                    (this.BusinessHoursOverride != null &&
                    this.BusinessHoursOverride.Equals(input.BusinessHoursOverride))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.BusinessHoursOverride != null)
                    hashCode = hashCode * 59 + this.BusinessHoursOverride.GetHashCode();
