...
namespace Flipdish.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CurrencyData :  IEquatable<CurrencyData>, IValidatableObject
    {
        /// <summary>
        /// Currency
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CurrencyData" /> class.
        /// </summary>
        /// <param name="currency">Currency.</param>
        /// <param name="value">Value.</param>
        public CurrencyData(CurrencyEnum? currency = default(CurrencyEnum?), double? value = default(double?))
        {
        ...
        {
            return this.Equals(input as CurrencyData);
        }

        /// <summary>
        /// Returns true if CurrencyData instances are equal
        /// </summary>
        /// <param name="input">Instance of CurrencyData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CurrencyData input)
        {
            if (input == null)
                return false;
