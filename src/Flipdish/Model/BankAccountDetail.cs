...
namespace Flipdish.Model
{
    ...
    public partial class BankAccountDetail :  IEquatable<BankAccountDetail>, IValidatableObject
    {
        ...
        public BankAccountDetail(int? id = default(int?), List<string> storeNames = default(List<string>), AccountStateEnum? accountState = default(AccountStateEnum?), string bankAddress = default(string), string bankCountryCode = default(string), string accountHolderAddress = default(string), string accountHolderCountryCode = default(string), string vatNumber = default(string), string accountName = default(string), string iban = default(string), string swift = default(string))
        {
            this.Id = id;
