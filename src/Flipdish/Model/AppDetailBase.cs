...
namespace Flipdish.Model
{
    ...
    public partial class AppDetailBase :  IEquatable<AppDetailBase>, IValidatableObject
    {
        ...
        public AppDetailBase(ConfigurationTypeEnum configurationType = default(ConfigurationTypeEnum), StoreSelectorTypeEnum storeSelectorType = default(StoreSelectorTypeEnum), List<FieldGroup> fieldGroups = default(List<FieldGroup>), string setupInstructions = default(string), string externalSetupLink = default(string), string oAuthAppId = default(string), TeammateAppAccessLevelEnum? teammateAppAccessLevel = default(TeammateAppAccessLevelEnum?), PermissionsTypeEnum permissionsType = default(PermissionsTypeEnum), string name = default(string), string description = default(string), string logo = default(string), bool? isEnabled = default(bool?), VerificationStatusEnum verificationStatus = default(VerificationStatusEnum), List<string> tags = default(List<string>), List<string> regions = default(List<string>), string developerName = default(string))
        {
            ...
            {
                throw new InvalidDataException("permissionsType is a required property for AppDetailBase and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("verificationStatus is a required property for AppDetailBase and cannot be null");
            }
            else
            {
