...
namespace Flipdish.Model
{
    ...
    public partial class LocationAreaCreatedEvent :  IEquatable<LocationAreaCreatedEvent>
    {
        ...
        public LocationAreaCreatedEvent(string locationAreaId = default(string), string locationAreaName = default(string), UserEventInfo user = default(UserEventInfo), string eventName = default(string), Guid? flipdishEventId = default(Guid?), DateTime? createTime = default(DateTime?), int? position = default(int?), string appId = default(string), string orgId = default(string), string ipAddress = default(string))
        {
