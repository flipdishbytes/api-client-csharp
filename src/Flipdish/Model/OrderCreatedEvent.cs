...
namespace Flipdish.Model
{
    ...
    public partial class OrderCreatedEvent :  IEquatable<OrderCreatedEvent>
    {
        ...
        public OrderCreatedEvent(string eventName = default(string), string description = default(string), DateTime? orderCreatedTime = default(DateTime?), Order order = default(Order), Guid? flipdishEventId = default(Guid?), DateTime? createTime = default(DateTime?), int? position = default(int?), string appId = default(string), string ipAddress = default(string))
        {
