...
namespace Flipdish.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CustomerConsentUpdatedEvent :  IEquatable<CustomerConsentUpdatedEvent>
    {
        /// <summary>
        ...
        public CustomerConsentUpdatedEvent(string eventName = default(string), string orgId = default(string), bool? enabled = default(bool?), string description = default(string), UserEventInfo user = default(UserEventInfo), Guid? flipdishEventId = default(Guid?), DateTime? createTime = default(DateTime?), int? position = default(int?), string appId = default(string), string ipAddress = default(string), string activityId = default(string), string activityType = default(string))
        {
