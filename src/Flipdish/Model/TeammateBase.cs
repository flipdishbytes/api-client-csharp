...
namespace Flipdish.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TeammateBase :  IEquatable<TeammateBase>
    {
        /// <summary>
        /// App access level
        /// </summary>
        ...
        public TeammateBase(AppAccessLevelEnum? appAccessLevel = default(AppAccessLevelEnum?), bool? hasAccessToAllStores = default(bool?), List<int?> storeIds = default(List<int?>), List<string> propertyIds = default(List<string>))
        {
