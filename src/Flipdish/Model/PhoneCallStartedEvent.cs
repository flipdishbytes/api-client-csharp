...
namespace Flipdish.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PhoneCallStartedEvent :  IEquatable<PhoneCallStartedEvent>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PhoneCallStartedEvent" /> class.
        /// </summary>
        /// <param name="eventName">The event name.</param>
        /// <param name="description">Description.</param>
        /// <param name="storeId">Store Id.</param>
        /// <param name="phoneCall">The phone call.</param>
        ...
        public PhoneCallStartedEvent(string eventName = default(string), string description = default(string), int? storeId = default(int?), PhoneCall phoneCall = default(PhoneCall), Guid? flipdishEventId = default(Guid?), DateTime? createTime = default(DateTime?), int? position = default(int?), string appId = default(string), string orgId = default(string), string ipAddress = default(string), string activityId = default(string), string activityType = default(string))
        {
        ...
        {
            return this.Equals(input as PhoneCallStartedEvent);
        }

        /// <summary>
        /// Returns true if PhoneCallStartedEvent instances are equal
        /// </summary>
        /// <param name="input">Instance of PhoneCallStartedEvent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PhoneCallStartedEvent input)
        {
            if (input == null)
                return false;
