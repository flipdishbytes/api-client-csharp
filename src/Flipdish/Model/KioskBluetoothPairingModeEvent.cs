...
namespace Flipdish.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class KioskBluetoothPairingModeEvent :  IEquatable<KioskBluetoothPairingModeEvent>
    {
        /// <summary>
        /// Terminal Type
        /// </summary>
        ...
        {
            return this.Equals(input as KioskBluetoothPairingModeEvent);
        }

        /// <summary>
        /// Returns true if KioskBluetoothPairingModeEvent instances are equal
        /// </summary>
        /// <param name="input">Instance of KioskBluetoothPairingModeEvent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(KioskBluetoothPairingModeEvent input)
        {
            if (input == null)
                return false;
