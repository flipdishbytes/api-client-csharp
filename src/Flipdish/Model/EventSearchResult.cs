...
namespace Flipdish.Model
{
    ...
    public partial class EventSearchResult :  IEquatable<EventSearchResult>
    {
        ...
        public List<BankAccountDeletedEvent> BankAccountAssignedEvent { get; set; }
