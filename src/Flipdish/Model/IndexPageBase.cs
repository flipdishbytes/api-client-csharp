...
namespace Flipdish.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class IndexPageBase :  IEquatable<IndexPageBase>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="IndexPageBase" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as IndexPageBase);
        }

        /// <summary>
        /// Returns true if IndexPageBase instances are equal
        /// </summary>
        /// <param name="input">Instance of IndexPageBase to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IndexPageBase input)
        {
            if (input == null)
                return false;
