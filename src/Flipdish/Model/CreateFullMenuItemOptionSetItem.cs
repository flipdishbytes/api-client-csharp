...
namespace Flipdish.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CreateFullMenuItemOptionSetItem :  IEquatable<CreateFullMenuItemOptionSetItem>
    {
        /// <summary>
        ...
        public CreateFullMenuItemOptionSetItem(int? menuItemOptionSetItemId = default(int?), List<CreateMetadata> metadata = default(List<CreateMetadata>), string taxRateName = default(string), int? nextMenuItemOptionSetId = default(int?), string name = default(string), double? price = default(double?), double? depositReturnFee = default(double?), bool? isAvailable = default(bool?), int? displayOrder = default(int?), CellLayoutTypeEnum? cellLayoutType = default(CellLayoutTypeEnum?), string imageUrl = default(string), Guid? publicId = default(Guid?))
        {
