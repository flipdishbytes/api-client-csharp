...
namespace Flipdish.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class HydraRequestResetEvent :  IEquatable<HydraRequestResetEvent>
    {
        /// <summary>
        ...
        public HydraRequestResetEvent(UserEventInfo user = default(UserEventInfo), string eventName = default(string), Guid? flipdishEventId = default(Guid?), DateTime? createTime = default(DateTime?), int? position = default(int?), string appId = default(string), string orgId = default(string), string ipAddress = default(string), string activityId = default(string), string activityType = default(string))
        {
            this.User = user;
        ...
        /// </summary>
        /// <value>User who initiated the change</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class HydraRequestResetEvent {\n");
        ...
        {
            return this.Equals(input as HydraRequestResetEvent);
        }

        /// <summary>
        /// Returns true if HydraRequestResetEvent instances are equal
        /// </summary>
        /// <param name="input">Instance of HydraRequestResetEvent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(HydraRequestResetEvent input)
        {
            if (input == null)
                return false;
