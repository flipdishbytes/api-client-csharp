...
namespace Flipdish.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class WebhookSubscriptionUpdatedEvent :  IEquatable<WebhookSubscriptionUpdatedEvent>
    {
        /// <summary>
        ...
        public WebhookSubscriptionUpdatedEvent(string eventName = default(string), WebhookSubscriptionEventInfo webhookSubscriptionEventInfo = default(WebhookSubscriptionEventInfo), Guid? flipdishEventId = default(Guid?), DateTime? createTime = default(DateTime?), int? position = default(int?), string appId = default(string), string orgId = default(string), string ipAddress = default(string), string activityId = default(string), string activityType = default(string))
        {
        ...
        {
            return this.Equals(input as WebhookSubscriptionUpdatedEvent);
        }

        /// <summary>
        /// Returns true if WebhookSubscriptionUpdatedEvent instances are equal
        /// </summary>
        /// <param name="input">Instance of WebhookSubscriptionUpdatedEvent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WebhookSubscriptionUpdatedEvent input)
        {
            if (input == null)
                return false;
