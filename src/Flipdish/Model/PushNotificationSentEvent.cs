...
namespace Flipdish.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PushNotificationSentEvent :  IEquatable<PushNotificationSentEvent>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PushNotificationSentEvent" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as PushNotificationSentEvent);
        }

        /// <summary>
        /// Returns true if PushNotificationSentEvent instances are equal
        /// </summary>
        /// <param name="input">Instance of PushNotificationSentEvent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PushNotificationSentEvent input)
        {
            if (input == null)
                return false;
