...
namespace Flipdish.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class WebhookSubscriptionCreatedEvent :  IEquatable<WebhookSubscriptionCreatedEvent>, IValidatableObject
    {
        /// <summary>
        ...
        public WebhookSubscriptionCreatedEvent(string eventName = default(string), WebhookSubscriptionEventInfo webhookSubscriptionEventInfo = default(WebhookSubscriptionEventInfo), Guid? flipdishEventId = default(Guid?), DateTime? createTime = default(DateTime?), int? position = default(int?), string appId = default(string), string ipAddress = default(string))
        {
