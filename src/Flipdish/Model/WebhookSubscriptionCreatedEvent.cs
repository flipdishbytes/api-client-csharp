...
namespace Flipdish.Model
{
    ...
    public partial class WebhookSubscriptionCreatedEvent :  IEquatable<WebhookSubscriptionCreatedEvent>
    {
        ...
        public WebhookSubscriptionCreatedEvent(string eventName = default(string), WebhookSubscriptionEventInfo webhookSubscriptionEventInfo = default(WebhookSubscriptionEventInfo), Guid? flipdishEventId = default(Guid?), DateTime? createTime = default(DateTime?), int? position = default(int?), string appId = default(string), string orgId = default(string), string ipAddress = default(string))
        {
