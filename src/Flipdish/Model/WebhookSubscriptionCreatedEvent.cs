...
namespace Flipdish.Model
{
    ...
    public partial class WebhookSubscriptionCreatedEvent :  IEquatable<WebhookSubscriptionCreatedEvent>, IValidatableObject
    {
        ...
        public WebhookSubscriptionCreatedEvent(WebhookSubscriptionEventInfo WebhookSubscriptionEventInfo = default(WebhookSubscriptionEventInfo), string EventName = default(string), Guid? FlipdishEventId = default(Guid?), DateTime? CreateTime = default(DateTime?), int? Position = default(int?))
        {
