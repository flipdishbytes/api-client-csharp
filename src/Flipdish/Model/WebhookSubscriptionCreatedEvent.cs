...
namespace Flipdish.Model
{
    ...
    public partial class WebhookSubscriptionCreatedEvent :  IEquatable<WebhookSubscriptionCreatedEvent>, IValidatableObject
    {
        ...
        public WebhookSubscriptionCreatedEvent(string EventName = default(string), WebhookSubscriptionEventInfo WebhookSubscriptionEventInfo = default(WebhookSubscriptionEventInfo), Guid? FlipdishEventId = default(Guid?), DateTime? CreateTime = default(DateTime?), int? Position = default(int?))
        {
