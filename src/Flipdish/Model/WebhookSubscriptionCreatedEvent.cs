...
namespace Flipdish.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class WebhookSubscriptionCreatedEvent :  IEquatable<WebhookSubscriptionCreatedEvent>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WebhookSubscriptionCreatedEvent" /> class.
        /// </summary>
        ...
        public WebhookSubscriptionCreatedEvent(string eventName = default(string), WebhookSubscriptionEventInfo webhookSubscriptionEventInfo = default(WebhookSubscriptionEventInfo), Guid? flipdishEventId = default(Guid?), DateTime? createTime = default(DateTime?), int? position = default(int?), string appId = default(string), string orgId = default(string), string ipAddress = default(string), string activityId = default(string), string activityType = default(string))
        {
        ...
        {
            return this.Equals(input as WebhookSubscriptionCreatedEvent);
        }

        /// <summary>
        /// Returns true if WebhookSubscriptionCreatedEvent instances are equal
        /// </summary>
        /// <param name="input">Instance of WebhookSubscriptionCreatedEvent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WebhookSubscriptionCreatedEvent input)
        {
            if (input == null)
                return false;
