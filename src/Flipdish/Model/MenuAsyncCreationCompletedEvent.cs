...
namespace Flipdish.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class MenuAsyncCreationCompletedEvent :  IEquatable<MenuAsyncCreationCompletedEvent>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MenuAsyncCreationCompletedEvent" /> class.
        /// </summary>
        ...
        public MenuAsyncCreationCompletedEvent(string eventName = default(string), string description = default(string), UserEventInfo user = default(UserEventInfo), Menu menu = default(Menu), bool? success = default(bool?), Guid? flipdishEventId = default(Guid?), DateTime? createTime = default(DateTime?), int? position = default(int?), string appId = default(string), string orgId = default(string), string ipAddress = default(string), string activityId = default(string), string activityType = default(string))
        {
        ...
        {
            return this.Equals(input as MenuAsyncCreationCompletedEvent);
        }

        /// <summary>
        /// Returns true if MenuAsyncCreationCompletedEvent instances are equal
        /// </summary>
        /// <param name="input">Instance of MenuAsyncCreationCompletedEvent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MenuAsyncCreationCompletedEvent input)
        {
            if (input == null)
                return false;
