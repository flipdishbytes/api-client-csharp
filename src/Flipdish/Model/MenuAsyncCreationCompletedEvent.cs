...
namespace Flipdish.Model
{
    ...
    public partial class MenuAsyncCreationCompletedEvent :  IEquatable<MenuAsyncCreationCompletedEvent>
    {
        ...
        public MenuAsyncCreationCompletedEvent(string eventName = default(string), string description = default(string), UserEventInfo user = default(UserEventInfo), Menu menu = default(Menu), bool? success = default(bool?), Guid? flipdishEventId = default(Guid?), DateTime? createTime = default(DateTime?), int? position = default(int?), string appId = default(string), string orgId = default(string), string ipAddress = default(string))
        {
