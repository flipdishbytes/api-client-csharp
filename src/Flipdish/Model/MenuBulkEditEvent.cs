...
namespace Flipdish.Model
{
    ...
    public partial class MenuBulkEditEvent :  IEquatable<MenuBulkEditEvent>
    {
        ...
        public MenuBulkEditEvent(string eventName = default(string), string menuName = default(string), string description = default(string), string item = default(string), int? instanceCount = default(int?), bool? isAvailable = default(bool?), UserEventInfo user = default(UserEventInfo), int? menuId = default(int?), Guid? flipdishEventId = default(Guid?), DateTime? createTime = default(DateTime?), int? position = default(int?), string appId = default(string), string orgId = default(string), string ipAddress = default(string))
        {
