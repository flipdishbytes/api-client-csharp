...
namespace Flipdish.Model
{
    ...
    public partial class LoyaltyCampaignCreatedEvent :  IEquatable<LoyaltyCampaignCreatedEvent>, IValidatableObject
    {
        ...
        public LoyaltyCampaignCreatedEvent(string EventName = default(string), string Description = default(string), int? StoreId = default(int?), LoyaltyCampaign LoyaltyCampaign = default(LoyaltyCampaign), Guid? FlipdishEventId = default(Guid?), DateTime? CreateTime = default(DateTime?), int? Position = default(int?))
        {
