...
namespace Flipdish.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TelephonyConfigUpdatedEvent :  IEquatable<TelephonyConfigUpdatedEvent>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TelephonyConfigUpdatedEvent" /> class.
        /// </summary>
        ...
        public TelephonyConfigUpdatedEvent(string eventName = default(string), string description = default(string), int? storeId = default(int?), TelephonyConfig telephonyConfig = default(TelephonyConfig), string propertyId = default(string), Guid? flipdishEventId = default(Guid?), DateTime? createTime = default(DateTime?), int? position = default(int?), string appId = default(string), string orgId = default(string), string ipAddress = default(string), string activityId = default(string), string activityType = default(string))
        {
        ...
        {
            return this.Equals(input as TelephonyConfigUpdatedEvent);
        }

        /// <summary>
        /// Returns true if TelephonyConfigUpdatedEvent instances are equal
        /// </summary>
        /// <param name="input">Instance of TelephonyConfigUpdatedEvent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TelephonyConfigUpdatedEvent input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.TelephonyConfig == input.TelephonyConfig ||
