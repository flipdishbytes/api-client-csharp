...
namespace Flipdish.Model
{
    ...
    public partial class AppStoreConfigCreatedEvent :  IEquatable<AppStoreConfigCreatedEvent>, IValidatableObject
    {
        ...
        public AppStoreConfigCreatedEvent(string eventName = default(string), string appStoreAppId = default(string), string appStoreAppConfigurationId = default(string), Guid? flipdishEventId = default(Guid?), DateTime? createTime = default(DateTime?), int? position = default(int?), string appId = default(string))
        {
