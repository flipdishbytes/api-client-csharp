...
namespace Flipdish.Model
{
    ...
    public partial class AppStoreConfigCreatedEvent :  IEquatable<AppStoreConfigCreatedEvent>
    {
        ...
        public AppStoreConfigCreatedEvent(string eventName = default(string), string appStoreAppId = default(string), string appStoreAppConfigurationId = default(string), UserEventInfo user = default(UserEventInfo), Guid? flipdishEventId = default(Guid?), DateTime? createTime = default(DateTime?), int? position = default(int?), string appId = default(string), string ipAddress = default(string))
        {
