...
namespace Flipdish.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AppStoreConfigCreatedEvent :  IEquatable<AppStoreConfigCreatedEvent>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AppStoreConfigCreatedEvent" /> class.
        /// </summary>
        ...
        /// <param name="user">User who has created the configuration.</param>
        ...
        public AppStoreConfigCreatedEvent(string eventName = default(string), string appStoreAppId = default(string), string appStoreAppConfigurationId = default(string), UserEventInfo user = default(UserEventInfo), Guid? flipdishEventId = default(Guid?), DateTime? createTime = default(DateTime?), int? position = default(int?), string appId = default(string), string orgId = default(string), string ipAddress = default(string), string activityId = default(string), string activityType = default(string))
        {
        ...
        /// </summary>
        /// <value>User who has created the configuration</value>
        ...
        {
            return this.Equals(input as AppStoreConfigCreatedEvent);
        }

        /// <summary>
        /// Returns true if AppStoreConfigCreatedEvent instances are equal
        /// </summary>
        /// <param name="input">Instance of AppStoreConfigCreatedEvent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AppStoreConfigCreatedEvent input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.AppStoreAppConfigurationId == input.AppStoreAppConfigurationId ||
                    (this.AppStoreAppConfigurationId != null &&
