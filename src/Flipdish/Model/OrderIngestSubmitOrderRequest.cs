...
namespace Flipdish.Model
{
    ...
    public partial class OrderIngestSubmitOrderRequest :  IEquatable<OrderIngestSubmitOrderRequest>, IValidatableObject
    {
        ...
        /// </summary>
        /// <value>[Required] Indicated the name from where the request is coming from</value>
        ...
        /// </summary>
        /// <value>[Required] Currency Code  These must match three letter codes ISO 4127 http://en.wikipedia.org/wiki/ISO_4217</value>
        [JsonConverter(typeof(StringEnumConverter))]
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="OrderIngestSubmitOrderRequest" /> class.
        /// </summary>
        /// <param name="appType">[Required] Indicated the name from where the request is coming from.</param>
        /// <param name="storeId">[Required] Store Id.</param>
        ...
        /// </summary>
        /// <value>[Required] Cart of the user</value>
        ...
        /// </summary>
        /// <value>[Required] Relevant fulfillment Information</value>
        [DataMember(Name="FulfillmentInfo", EmitDefaultValue=false)]
        ...
        /// </summary>
        /// <value>Date the order was placed at in UTC  [Required]</value>
        ...
        /// </summary>
        /// <value>Payment Information  [Required]</value>
        ...
        /// </summary>
        /// <value>Contact Information  [Required]</value>
        ...
        {
            return this.Equals(input as OrderIngestSubmitOrderRequest);
        }

        /// <summary>
        /// Returns true if OrderIngestSubmitOrderRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of OrderIngestSubmitOrderRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OrderIngestSubmitOrderRequest input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.FulfillmentInfo == input.FulfillmentInfo ||
