...
namespace Flipdish.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CspReportRequest :  IEquatable<CspReportRequest>
    {
        /// <summary>
        ...
        {
            this.Csp_report = cspReport;
        }
        
        /// <summary>
        /// Gets or Sets Csp_report
        /// </summary>
        [DataMember(Name="Csp-report", EmitDefaultValue=false)]
        public CspReport Csp_report { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  Csp_report: ").Append(Csp_report).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        public bool Equals(CspReportRequest input)
        {
            ...
            return 
                (
                    this.Csp_report == input.Csp_report ||
                    (this.Csp_report != null &&
                    this.Csp_report.Equals(input.Csp_report))
                );
        }
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                if (this.Csp_report != null)
                    hashCode = hashCode * 59 + this.Csp_report.GetHashCode();
                return hashCode;
            }
        }
    }
