...
namespace Flipdish.Model
{
    ...
    public partial class KioskTerminalActionStateChangedEvent :  IEquatable<KioskTerminalActionStateChangedEvent>
    {
        ...
        public KioskTerminalActionStateChangedEvent(string readerId = default(string), BluetoothTerminalTypeEnum? bluetoothTerminalType = default(BluetoothTerminalTypeEnum?), string actionState = default(string), string failureCode = default(string), string eventName = default(string), Guid? flipdishEventId = default(Guid?), DateTime? createTime = default(DateTime?), int? position = default(int?), string appId = default(string), string orgId = default(string), string ipAddress = default(string), string activityId = default(string), string activityType = default(string))
        {
