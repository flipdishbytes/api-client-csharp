...
namespace Flipdish.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DeliveryZoneCreatedEvent :  IEquatable<DeliveryZoneCreatedEvent>, IValidatableObject
    {
        /// <summary>
        ...
        public DeliveryZoneCreatedEvent(string EventName = default(string), int? StoreId = default(int?), UserEventInfo User = default(UserEventInfo), string Description = default(string), DeliveryZone DeliveryZone = default(DeliveryZone), Guid? FlipdishEventId = default(Guid?), DateTime? CreateTime = default(DateTime?), int? Position = default(int?))
        {
