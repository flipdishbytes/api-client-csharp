...
namespace Flipdish.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CustomerCreatedEvent :  IEquatable<CustomerCreatedEvent>
    {
        /// <summary>
        ...
        public CustomerCreatedEvent(string eventName = default(string), string orgId = default(string), UserEventInfo user = default(UserEventInfo), string description = default(string), Guid? flipdishEventId = default(Guid?), DateTime? createTime = default(DateTime?), int? position = default(int?), string appId = default(string), string ipAddress = default(string), string activityId = default(string), string activityType = default(string))
        {
