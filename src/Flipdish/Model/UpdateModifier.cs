...
namespace Flipdish.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class UpdateModifier :  IEquatable<UpdateModifier>, IValidatableObject
    {
        /// <summary>
        ...
        public UpdateModifier(string sku = default(string), string name = default(string), string description = default(string), double? price = default(double?), bool? alcohol = default(bool?))
        {
            this.Sku = sku;
            this.Name = name;
