...
namespace Flipdish.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class RestApiResultMenu :  IEquatable<RestApiResultMenu>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as RestApiResultMenu);
        }

        /// <summary>
        /// Returns true if RestApiResultMenu instances are equal
        /// </summary>
        /// <param name="input">Instance of RestApiResultMenu to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RestApiResultMenu input)
        {
            if (input == null)
                return false;
