...
namespace Flipdish.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class VoucherUpdatedEvent :  IEquatable<VoucherUpdatedEvent>, IValidatableObject
    {
        /// <summary>
        ...
        public VoucherUpdatedEvent(int? voucherId = default(int?), string eventName = default(string), UserEventInfo user = default(UserEventInfo), string description = default(string), Voucher voucher = default(Voucher), Guid? flipdishEventId = default(Guid?), DateTime? createTime = default(DateTime?), int? position = default(int?), string appId = default(string))
        {
