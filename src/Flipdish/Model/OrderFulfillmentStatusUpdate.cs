...
namespace Flipdish.Model
{
    ...
    public partial class OrderFulfillmentStatusUpdate :  IEquatable<OrderFulfillmentStatusUpdate>, IValidatableObject
    {
        ...
        public OrderFulfillmentStatusUpdate(string statusId = default(string))
        {
        ...
        {
            return this.Equals(input as OrderFulfillmentStatusUpdate);
        }

        /// <summary>
        /// Returns true if OrderFulfillmentStatusUpdate instances are equal
        /// </summary>
        /// <param name="input">Instance of OrderFulfillmentStatusUpdate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OrderFulfillmentStatusUpdate input)
        {
            if (input == null)
                return false;
