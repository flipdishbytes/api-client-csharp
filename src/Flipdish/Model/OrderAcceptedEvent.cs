...
namespace Flipdish.Model
{
    ...
    public partial class OrderAcceptedEvent :  IEquatable<OrderAcceptedEvent>, IValidatableObject
    {
        ...
        public OrderAcceptedEvent(string eventName = default(string), string description = default(string), DateTime? orderAcceptedTime = default(DateTime?), Order order = default(Order), Guid? flipdishEventId = default(Guid?), DateTime? createTime = default(DateTime?), int? position = default(int?), string appId = default(string))
        {
