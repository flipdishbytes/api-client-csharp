...
namespace Flipdish.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OrderAcceptedEvent :  IEquatable<OrderAcceptedEvent>
    {
        /// <summary>
        ...
        public OrderAcceptedEvent(string eventName = default(string), string orgId = default(string), string description = default(string), DateTime? orderAcceptedTime = default(DateTime?), UserEventInfo user = default(UserEventInfo), Order order = default(Order), Guid? flipdishEventId = default(Guid?), DateTime? createTime = default(DateTime?), int? position = default(int?), string appId = default(string), string ipAddress = default(string), string activityId = default(string), string activityType = default(string))
        {
