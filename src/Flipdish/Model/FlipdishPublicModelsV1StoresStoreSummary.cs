...
{
    /// <summary>
    /// FlipdishPublicModelsV1StoresStoreSummary
    /// </summary>
    [DataContract]
    public partial class FlipdishPublicModelsV1StoresStoreSummary :  IEquatable<FlipdishPublicModelsV1StoresStoreSummary>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="FlipdishPublicModelsV1StoresStoreSummary" /> class.
        /// </summary>
        ...
        public FlipdishPublicModelsV1StoresStoreSummary(int? Id = default(int?), string Name = default(string), int? MenuId = default(int?), Dictionary<string, string> Metadata = default(Dictionary<string, string>), CurrencyEnum? Currency = default(CurrencyEnum?))
        {
            this.Id = Id;
            this.Name = Name;
            this.MenuId = MenuId;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class FlipdishPublicModelsV1StoresStoreSummary {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as FlipdishPublicModelsV1StoresStoreSummary);
        }

        /// <summary>
        /// Returns true if FlipdishPublicModelsV1StoresStoreSummary instances are equal
        /// </summary>
        /// <param name="other">Instance of FlipdishPublicModelsV1StoresStoreSummary to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FlipdishPublicModelsV1StoresStoreSummary other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
