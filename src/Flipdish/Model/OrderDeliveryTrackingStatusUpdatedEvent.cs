...
namespace Flipdish.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OrderDeliveryTrackingStatusUpdatedEvent :  IEquatable<OrderDeliveryTrackingStatusUpdatedEvent>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OrderDeliveryTrackingStatusUpdatedEvent" /> class.
        /// </summary>
        ...
        public OrderDeliveryTrackingStatusUpdatedEvent(string eventName = default(string), string description = default(string), Order order = default(Order), string deliveryIntegrationName = default(string), string deliveryErrorMessage = default(string), Guid? flipdishEventId = default(Guid?), DateTime? createTime = default(DateTime?), int? position = default(int?), string appId = default(string), string orgId = default(string), string ipAddress = default(string), string activityId = default(string), string activityType = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class OrderDeliveryTrackingStatusUpdatedEvent {\n");
        ...
        {
            return this.Equals(input as OrderDeliveryTrackingStatusUpdatedEvent);
        }

        /// <summary>
        /// Returns true if OrderDeliveryTrackingStatusUpdatedEvent instances are equal
        /// </summary>
        /// <param name="input">Instance of OrderDeliveryTrackingStatusUpdatedEvent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OrderDeliveryTrackingStatusUpdatedEvent input)
        {
            if (input == null)
                return false;
