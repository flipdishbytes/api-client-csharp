...
namespace Flipdish.Model
{
    ...
    public partial class OrderDeliveryTrackingStatusUpdatedEvent :  IEquatable<OrderDeliveryTrackingStatusUpdatedEvent>
    {
        ...
        public OrderDeliveryTrackingStatusUpdatedEvent(string eventName = default(string), string description = default(string), Order order = default(Order), string deliveryIntegrationName = default(string), string deliveryErrorMessage = default(string), Guid? flipdishEventId = default(Guid?), DateTime? createTime = default(DateTime?), int? position = default(int?), string appId = default(string), string orgId = default(string), string ipAddress = default(string))
        {
