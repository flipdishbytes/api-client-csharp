...
namespace Flipdish.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class WebsiteUpdatedEvent :  IEquatable<WebsiteUpdatedEvent>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WebsiteUpdatedEvent" /> class.
        /// </summary>
        /// <param name="appNameId">App Name id of the whitelabel of the website.</param>
        /// <param name="user">User updating the website.</param>
        ...
        public WebsiteUpdatedEvent(string appNameId = default(string), UserEventInfo user = default(UserEventInfo), string description = default(string), string eventName = default(string), Guid? flipdishEventId = default(Guid?), DateTime? createTime = default(DateTime?), int? position = default(int?), string appId = default(string), string orgId = default(string), string ipAddress = default(string), string activityId = default(string), string activityType = default(string))
        {
        ...
        /// </summary>
        /// <value>App Name id of the whitelabel of the website</value>
        ...
        /// </summary>
        /// <value>User updating the website</value>
        ...
        {
            return this.Equals(input as WebsiteUpdatedEvent);
        }

        /// <summary>
        /// Returns true if WebsiteUpdatedEvent instances are equal
        /// </summary>
        /// <param name="input">Instance of WebsiteUpdatedEvent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WebsiteUpdatedEvent input)
        {
            if (input == null)
                return false;
