...
namespace Flipdish.Model
{
    ...
    public partial class AppStoreAppConfigurationsWithSubscriptions :  IEquatable<AppStoreAppConfigurationsWithSubscriptions>
    {
        ...
        {
            return this.Equals(input as AppStoreAppConfigurationsWithSubscriptions);
        }

        /// <summary>
        /// Returns true if AppStoreAppConfigurationsWithSubscriptions instances are equal
        /// </summary>
        /// <param name="input">Instance of AppStoreAppConfigurationsWithSubscriptions to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AppStoreAppConfigurationsWithSubscriptions input)
        {
            if (input == null)
                return false;
