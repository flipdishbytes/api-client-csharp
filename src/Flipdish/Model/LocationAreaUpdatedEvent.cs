...
namespace Flipdish.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class LocationAreaUpdatedEvent :  IEquatable<LocationAreaUpdatedEvent>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LocationAreaUpdatedEvent" /> class.
        /// </summary>
        /// <param name="locationAreaId">LocationArea Id.</param>
        /// <param name="locationAreaName">LocationArea Name.</param>
        /// <param name="user">User who updated the LocationArea.</param>
        ...
        public LocationAreaUpdatedEvent(string locationAreaId = default(string), string locationAreaName = default(string), UserEventInfo user = default(UserEventInfo), string eventName = default(string), Guid? flipdishEventId = default(Guid?), DateTime? createTime = default(DateTime?), int? position = default(int?), string appId = default(string), string orgId = default(string), string ipAddress = default(string), string activityId = default(string), string activityType = default(string))
        {
        ...
        /// </summary>
        /// <value>User who updated the LocationArea</value>
        ...
        {
            return this.Equals(input as LocationAreaUpdatedEvent);
        }

        /// <summary>
        /// Returns true if LocationAreaUpdatedEvent instances are equal
        /// </summary>
        /// <param name="input">Instance of LocationAreaUpdatedEvent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LocationAreaUpdatedEvent input)
        {
            if (input == null)
                return false;
