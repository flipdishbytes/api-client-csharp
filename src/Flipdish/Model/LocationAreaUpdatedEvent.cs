...
namespace Flipdish.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class LocationAreaUpdatedEvent :  IEquatable<LocationAreaUpdatedEvent>, IValidatableObject
    {
        /// <summary>
        ...
        public LocationAreaUpdatedEvent(string locationAreaId = default(string), string locationAreaName = default(string), UserEventInfo user = default(UserEventInfo), string eventName = default(string), Guid? flipdishEventId = default(Guid?), DateTime? createTime = default(DateTime?), int? position = default(int?), string appId = default(string), string ipAddress = default(string))
        {
