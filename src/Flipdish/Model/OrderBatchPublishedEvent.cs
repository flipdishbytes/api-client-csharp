...
namespace Flipdish.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OrderBatchPublishedEvent :  IEquatable<OrderBatchPublishedEvent>
    {
        /// <summary>
        ...
        public OrderBatchPublishedEvent(string eventName = default(string), int? orderBatchId = default(int?), int? storeId = default(int?), List<int?> orderIds = default(List<int?>), Guid? flipdishEventId = default(Guid?), DateTime? createTime = default(DateTime?), int? position = default(int?), string appId = default(string), string orgId = default(string), string ipAddress = default(string), string activityId = default(string), string activityType = default(string))
        {
        ...
        /// </summary>
        /// <value>Store id the order batch belogs to</value>
        ...
        {
            return this.Equals(input as OrderBatchPublishedEvent);
        }

        /// <summary>
        /// Returns true if OrderBatchPublishedEvent instances are equal
        /// </summary>
        /// <param name="input">Instance of OrderBatchPublishedEvent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OrderBatchPublishedEvent input)
        {
            if (input == null)
                return false;
