...
namespace Flipdish.Model
{
    ...
    public partial class OrderBatchPublishedEvent :  IEquatable<OrderBatchPublishedEvent>
    {
        ...
        public OrderBatchPublishedEvent(string eventName = default(string), int? orderBatchId = default(int?), int? storeId = default(int?), List<int?> orderIds = default(List<int?>), Guid? flipdishEventId = default(Guid?), DateTime? createTime = default(DateTime?), int? position = default(int?), string appId = default(string), string orgId = default(string), string ipAddress = default(string))
        {
