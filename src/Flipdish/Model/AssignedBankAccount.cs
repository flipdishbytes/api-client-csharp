...
namespace Flipdish.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AssignedBankAccount :  IEquatable<AssignedBankAccount>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AssignedBankAccount" /> class.
        /// </summary>
        /// <param name="id">Id of Bank Account.</param>
        /// <param name="bankAccountName">Name of Bank Account.</param>
        public AssignedBankAccount(int? id = default(int?), string bankAccountName = default(string))
        {
            this.Id = id;
        ...
        /// Id of Bank Account
        /// </summary>
        /// <value>Id of Bank Account</value>
        ...
        {
            return this.Equals(input as AssignedBankAccount);
        }

        /// <summary>
        /// Returns true if AssignedBankAccount instances are equal
        /// </summary>
        /// <param name="input">Instance of AssignedBankAccount to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AssignedBankAccount input)
        {
            if (input == null)
                return false;
