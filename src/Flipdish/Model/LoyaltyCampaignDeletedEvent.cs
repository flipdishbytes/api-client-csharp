...
namespace Flipdish.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class LoyaltyCampaignDeletedEvent :  IEquatable<LoyaltyCampaignDeletedEvent>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LoyaltyCampaignDeletedEvent" /> class.
        /// </summary>
        ...
        public LoyaltyCampaignDeletedEvent(string eventName = default(string), string description = default(string), int? storeId = default(int?), UserEventInfo user = default(UserEventInfo), LoyaltyCampaign loyaltyCampaign = default(LoyaltyCampaign), Guid? flipdishEventId = default(Guid?), DateTime? createTime = default(DateTime?), int? position = default(int?), string appId = default(string), string orgId = default(string), string ipAddress = default(string), string activityId = default(string), string activityType = default(string))
        {
        ...
        {
            return this.Equals(input as LoyaltyCampaignDeletedEvent);
        }

        /// <summary>
        /// Returns true if LoyaltyCampaignDeletedEvent instances are equal
        /// </summary>
        /// <param name="input">Instance of LoyaltyCampaignDeletedEvent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LoyaltyCampaignDeletedEvent input)
        {
            if (input == null)
                return false;
