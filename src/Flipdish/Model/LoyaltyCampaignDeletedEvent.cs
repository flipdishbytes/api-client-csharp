...
namespace Flipdish.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class LoyaltyCampaignDeletedEvent :  IEquatable<LoyaltyCampaignDeletedEvent>, IValidatableObject
    {
        /// <summary>
        ...
        public LoyaltyCampaignDeletedEvent(string eventName = default(string), string description = default(string), int? storeId = default(int?), UserEventInfo user = default(UserEventInfo), LoyaltyCampaign loyaltyCampaign = default(LoyaltyCampaign), Guid? flipdishEventId = default(Guid?), DateTime? createTime = default(DateTime?), int? position = default(int?), string appId = default(string), string ipAddress = default(string))
        {
