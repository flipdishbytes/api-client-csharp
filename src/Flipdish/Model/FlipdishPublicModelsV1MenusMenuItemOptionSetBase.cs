...
{
    /// <summary>
    /// FlipdishPublicModelsV1MenusMenuItemOptionSetBase
    /// </summary>
    [DataContract]
    public partial class FlipdishPublicModelsV1MenusMenuItemOptionSetBase :  IEquatable<FlipdishPublicModelsV1MenusMenuItemOptionSetBase>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="FlipdishPublicModelsV1MenusMenuItemOptionSetBase" /> class.
        /// </summary>
        ...
        public FlipdishPublicModelsV1MenusMenuItemOptionSetBase(string Name = default(string), bool? IsMasterOptionSet = default(bool?), int? DisplayOrder = default(int?), int? MinSelectCount = default(int?), int? MaxSelectCount = default(int?), CellLayoutTypeEnum? CellLayoutType = default(CellLayoutTypeEnum?))
        {
            this.Name = Name;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class FlipdishPublicModelsV1MenusMenuItemOptionSetBase {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as FlipdishPublicModelsV1MenusMenuItemOptionSetBase);
        }

        /// <summary>
        /// Returns true if FlipdishPublicModelsV1MenusMenuItemOptionSetBase instances are equal
        /// </summary>
        /// <param name="other">Instance of FlipdishPublicModelsV1MenusMenuItemOptionSetBase to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FlipdishPublicModelsV1MenusMenuItemOptionSetBase other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
