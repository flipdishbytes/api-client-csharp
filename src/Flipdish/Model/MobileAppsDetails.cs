...
namespace Flipdish.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class MobileAppsDetails :  IEquatable<MobileAppsDetails>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MobileAppsDetails" /> class.
        /// </summary>
        ...
        public MobileAppsDetails(string appName = default(string), string appDescription = default(string), string appShortDescription = default(string), List<string> keywords = default(List<string>), string appLogoUrl = default(string))
        {
        ...
        {
            return this.Equals(input as MobileAppsDetails);
        }

        /// <summary>
        /// Returns true if MobileAppsDetails instances are equal
        /// </summary>
        /// <param name="input">Instance of MobileAppsDetails to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MobileAppsDetails input)
        {
            if (input == null)
                return false;
