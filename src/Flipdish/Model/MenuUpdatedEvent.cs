...
namespace Flipdish.Model
{
    ...
    public partial class MenuUpdatedEvent :  IEquatable<MenuUpdatedEvent>, IValidatableObject
    {
        ...
        public MenuUpdatedEvent(string Description = default(string), UserEventInfo User = default(UserEventInfo), Menu Menu = default(Menu), string EventName = default(string), Guid? FlipdishEventId = default(Guid?), DateTime? CreateTime = default(DateTime?), string Details = default(string), int? Position = default(int?))
        {
