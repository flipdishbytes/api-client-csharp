...
namespace Flipdish.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class MenuUpdatedEvent :  IEquatable<MenuUpdatedEvent>
    {
        /// <summary>
        ...
        /// <param name="user">User who has updated the menu.</param>
        ...
        public MenuUpdatedEvent(string eventName = default(string), string description = default(string), UserEventInfo user = default(UserEventInfo), Menu menu = default(Menu), int? menuId = default(int?), Guid? flipdishEventId = default(Guid?), DateTime? createTime = default(DateTime?), int? position = default(int?), string appId = default(string), string orgId = default(string), string ipAddress = default(string), string activityId = default(string), string activityType = default(string))
        {
        ...
        /// </summary>
        /// <value>User who has updated the menu</value>
