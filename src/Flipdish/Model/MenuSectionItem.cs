...
namespace Flipdish.Model
{
    ...
    public partial class MenuSectionItem :  IEquatable<MenuSectionItem>, IValidatableObject
    {
        ...
        public MenuSectionItem(int? MenuItemId = default(int?), List<MenuItemOptionSet> MenuItemOptionSets = default(List<MenuItemOptionSet>), string Name = default(string), string Description = default(string), SpicinessRatingEnum? SpicinessRating = default(SpicinessRatingEnum?), double? Price = default(double?), double? ActualPrice = default(double?), int? DisplayOrder = default(int?), bool? Alcohol = default(bool?), bool? IsAvailable = default(bool?), string ImageUrl = default(string))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as MenuSectionItem);
        }

        /// <summary>
        /// Returns true if MenuSectionItem instances are equal
        /// </summary>
        /// <param name="other">Instance of MenuSectionItem to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MenuSectionItem other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
