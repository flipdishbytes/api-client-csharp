...
namespace Flipdish.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class BankAccountCreatedEvent :  IEquatable<BankAccountCreatedEvent>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BankAccountCreatedEvent" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as BankAccountCreatedEvent);
        }

        /// <summary>
        /// Returns true if BankAccountCreatedEvent instances are equal
        /// </summary>
        /// <param name="input">Instance of BankAccountCreatedEvent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BankAccountCreatedEvent input)
        {
            if (input == null)
                return false;
