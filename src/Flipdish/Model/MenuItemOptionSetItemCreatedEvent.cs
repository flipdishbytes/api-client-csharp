...
namespace Flipdish.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class MenuItemOptionSetItemCreatedEvent :  IEquatable<MenuItemOptionSetItemCreatedEvent>
    {
        /// <summary>
        ...
        public MenuItemOptionSetItemCreatedEvent(int? menuId = default(int?), string description = default(string), UserEventInfo user = default(UserEventInfo), MenuItemOptionSetItem menuItemOptionSetItem = default(MenuItemOptionSetItem), string eventName = default(string), Guid? flipdishEventId = default(Guid?), DateTime? createTime = default(DateTime?), int? position = default(int?), string appId = default(string), string orgId = default(string), string ipAddress = default(string), string activityId = default(string), string activityType = default(string))
        {
            this.MenuId = menuId;
