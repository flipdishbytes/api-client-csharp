...
namespace Flipdish.Model
{
    ...
    public partial class MenuItemOptionSetItemCreatedEvent :  IEquatable<MenuItemOptionSetItemCreatedEvent>
    {
        ...
        public MenuItemOptionSetItemCreatedEvent(int? menuId = default(int?), string description = default(string), UserEventInfo user = default(UserEventInfo), MenuItemOptionSetItem menuItemOptionSetItem = default(MenuItemOptionSetItem), string eventName = default(string), Guid? flipdishEventId = default(Guid?), DateTime? createTime = default(DateTime?), int? position = default(int?), string appId = default(string), string orgId = default(string), string ipAddress = default(string))
        {
            this.MenuId = menuId;
