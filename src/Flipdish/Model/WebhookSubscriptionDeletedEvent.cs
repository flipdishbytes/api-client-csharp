...
namespace Flipdish.Model
{
    ...
    public partial class WebhookSubscriptionDeletedEvent :  IEquatable<WebhookSubscriptionDeletedEvent>, IValidatableObject
    {
        ...
        public WebhookSubscriptionDeletedEvent(WebhookSubscriptionEventInfo WebhookSubscriptionEventInfo = default(WebhookSubscriptionEventInfo), string EventName = default(string), Guid? FlipdishEventId = default(Guid?), DateTime? CreateTime = default(DateTime?), int? Position = default(int?))
        {
