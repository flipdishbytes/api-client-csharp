...
namespace Flipdish.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class WebhookSubscriptionDeletedEvent :  IEquatable<WebhookSubscriptionDeletedEvent>
    {
        /// <summary>
        ...
        public WebhookSubscriptionDeletedEvent(string eventName = default(string), WebhookSubscriptionEventInfo webhookSubscriptionEventInfo = default(WebhookSubscriptionEventInfo), Guid? flipdishEventId = default(Guid?), DateTime? createTime = default(DateTime?), int? position = default(int?), string appId = default(string), string orgId = default(string), string ipAddress = default(string), string activityId = default(string), string activityType = default(string))
        {
