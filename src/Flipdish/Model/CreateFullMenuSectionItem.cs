...
namespace Flipdish.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CreateFullMenuSectionItem :  IEquatable<CreateFullMenuSectionItem>, IValidatableObject
    {
        /// <summary>
        /// Spiciness rating
        /// </summary>
        ...
        public List<CreateFullMenuItemOptionSet> MenuItemOptionSets { get; set; }
        ...
        {
            return this.Equals(input as CreateFullMenuSectionItem);
        }

        /// <summary>
        /// Returns true if CreateFullMenuSectionItem instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateFullMenuSectionItem to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateFullMenuSectionItem input)
        {
            if (input == null)
                return false;
