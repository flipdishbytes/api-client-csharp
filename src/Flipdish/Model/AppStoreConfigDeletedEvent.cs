...
namespace Flipdish.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AppStoreConfigDeletedEvent :  IEquatable<AppStoreConfigDeletedEvent>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AppStoreConfigDeletedEvent" /> class.
        /// </summary>
        ...
        public AppStoreConfigDeletedEvent(string eventName = default(string), string appStoreAppId = default(string), string appStoreAppConfigurationId = default(string), UserEventInfo user = default(UserEventInfo), Guid? flipdishEventId = default(Guid?), DateTime? createTime = default(DateTime?), int? position = default(int?), string appId = default(string), string orgId = default(string), string ipAddress = default(string), string activityId = default(string), string activityType = default(string))
        {
        ...
        {
            return this.Equals(input as AppStoreConfigDeletedEvent);
        }

        /// <summary>
        /// Returns true if AppStoreConfigDeletedEvent instances are equal
        /// </summary>
        /// <param name="input">Instance of AppStoreConfigDeletedEvent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AppStoreConfigDeletedEvent input)
        {
            if (input == null)
                return false;
