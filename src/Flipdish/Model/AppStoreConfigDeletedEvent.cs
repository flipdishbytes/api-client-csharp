...
namespace Flipdish.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AppStoreConfigDeletedEvent :  IEquatable<AppStoreConfigDeletedEvent>, IValidatableObject
    {
        /// <summary>
        ...
        public AppStoreConfigDeletedEvent(string eventName = default(string), string appStoreAppId = default(string), string appStoreAppConfigurationId = default(string), Guid? flipdishEventId = default(Guid?), DateTime? createTime = default(DateTime?), int? position = default(int?), string appId = default(string))
        {
