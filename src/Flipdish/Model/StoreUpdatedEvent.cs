...
namespace Flipdish.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class StoreUpdatedEvent :  IEquatable<StoreUpdatedEvent>, IValidatableObject
    {
        /// <summary>
        ...
        public StoreUpdatedEvent(int? StoreId = default(int?), UserEventInfo User = default(UserEventInfo), string Description = default(string), string EventName = default(string), Guid? FlipdishEventId = default(Guid?), DateTime? CreateTime = default(DateTime?), string Details = default(string), int? Position = default(int?))
        {
