...
namespace Flipdish.Model
{
    ...
    public partial class StoreUpdatedEvent :  IEquatable<StoreUpdatedEvent>, IValidatableObject
    {
        ...
        public StoreUpdatedEvent(int? StoreId = default(int?), UserEventInfo User = default(UserEventInfo), string Description = default(string), string EventName = default(string), Guid? FlipdishEventId = default(Guid?), DateTime? CreateTime = default(DateTime?), int? Position = default(int?))
        {
