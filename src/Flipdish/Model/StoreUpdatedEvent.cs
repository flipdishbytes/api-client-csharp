...
namespace Flipdish.Model
{
    ...
    public partial class StoreUpdatedEvent :  IEquatable<StoreUpdatedEvent>, IValidatableObject
    {
        ...
        public StoreUpdatedEvent(string EventName = default(string), int? StoreId = default(int?), UserEventInfo User = default(UserEventInfo), string Description = default(string), Guid? FlipdishEventId = default(Guid?), DateTime? CreateTime = default(DateTime?), int? Position = default(int?))
        {
