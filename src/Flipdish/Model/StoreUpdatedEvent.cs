...
namespace Flipdish.Model
{
    ...
    public partial class StoreUpdatedEvent :  IEquatable<StoreUpdatedEvent>, IValidatableObject
    {
        ...
        public StoreUpdatedEvent(string eventName = default(string), int? storeId = default(int?), UserEventInfo user = default(UserEventInfo), string description = default(string), Store store = default(Store), Guid? flipdishEventId = default(Guid?), DateTime? createTime = default(DateTime?), int? position = default(int?), string appId = default(string))
        {
