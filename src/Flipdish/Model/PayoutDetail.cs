...
namespace Flipdish.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PayoutDetail :  IEquatable<PayoutDetail>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PayoutDetail" /> class.
        /// </summary>
        ...
        /// <param name="payoutStores">Payout information broken down by Store.</param>
        ...
        public PayoutDetail(int? payoutId = default(int?), int? bankAccountId = default(int?), string accountName = default(string), PayoutStatusEnum? payoutStatus = default(PayoutStatusEnum?), DateTime? createdDate = default(DateTime?), DateTime? periodStartTime = default(DateTime?), DateTime? periodEndTime = default(DateTime?), string destinationBank = default(string), string destinationAccount = default(string), PayoutTypeEnum? payoutType = default(PayoutTypeEnum?), CurrencyEnum? currency = default(CurrencyEnum?), List<PayoutStore> payoutStores = default(List<PayoutStore>), double? amount = default(double?), DateTime? cutoffDate = default(DateTime?))
        {
        ...
        /// </summary>
        /// <value>Payout information broken down by Store</value>
        [DataMember(Name="PayoutStores", EmitDefaultValue=false)]
        public List<PayoutStore> PayoutStores { get; set; }
        ...
        {
            return this.Equals(input as PayoutDetail);
        }

        /// <summary>
        /// Returns true if PayoutDetail instances are equal
        /// </summary>
        /// <param name="input">Instance of PayoutDetail to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PayoutDetail input)
        {
            if (input == null)
                return false;
