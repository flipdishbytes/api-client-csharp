...
namespace Flipdish.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PrinterUnassignedFromStoreEvent :  IEquatable<PrinterUnassignedFromStoreEvent>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PrinterUnassignedFromStoreEvent" /> class.
        /// </summary>
        ...
        public PrinterUnassignedFromStoreEvent(string eventName = default(string), string description = default(string), int? storeId = default(int?), int? storeGroupId = default(int?), UserEventInfo user = default(UserEventInfo), Printer printer = default(Printer), Guid? flipdishEventId = default(Guid?), DateTime? createTime = default(DateTime?), int? position = default(int?), string appId = default(string), string orgId = default(string), string ipAddress = default(string), string activityId = default(string), string activityType = default(string))
        {
        ...
        {
            return this.Equals(input as PrinterUnassignedFromStoreEvent);
        }

        /// <summary>
        /// Returns true if PrinterUnassignedFromStoreEvent instances are equal
        /// </summary>
        /// <param name="input">Instance of PrinterUnassignedFromStoreEvent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PrinterUnassignedFromStoreEvent input)
        {
            if (input == null)
                return false;
