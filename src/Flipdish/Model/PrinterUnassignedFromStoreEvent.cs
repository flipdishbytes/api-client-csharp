...
namespace Flipdish.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PrinterUnassignedFromStoreEvent :  IEquatable<PrinterUnassignedFromStoreEvent>, IValidatableObject
    {
        /// <summary>
