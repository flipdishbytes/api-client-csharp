...
namespace Flipdish.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CreateModifier :  IEquatable<CreateModifier>, IValidatableObject
    {
        /// <summary>
        ...
        public CreateModifier(string sku = default(string), string name = default(string), string description = default(string), double? price = default(double?), string imageFileName = default(string))
        {
            this.Sku = sku;
            this.Name = name;
