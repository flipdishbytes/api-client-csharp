...
namespace Flipdish.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OrderBatchDetails :  IEquatable<OrderBatchDetails>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OrderBatchDetails" /> class.
        /// </summary>
        ...
        public OrderBatchDetails(int? orderBatchId = default(int?), string displayCode = default(string), DateTime? createTime = default(DateTime?), bool? isPublished = default(bool?))
        {
        ...
        {
            return this.Equals(input as OrderBatchDetails);
        }

        /// <summary>
        /// Returns true if OrderBatchDetails instances are equal
        /// </summary>
        /// <param name="input">Instance of OrderBatchDetails to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OrderBatchDetails input)
        {
            if (input == null)
                return false;
