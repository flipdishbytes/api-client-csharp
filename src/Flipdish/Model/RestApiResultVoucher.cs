...
namespace Flipdish.Model
{
    ...
    public partial class RestApiResultVoucher :  IEquatable<RestApiResultVoucher>, IValidatableObject
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as RestApiResultVoucher);
        }

        /// <summary>
        /// Returns true if RestApiResultVoucher instances are equal
        /// </summary>
        /// <param name="other">Instance of RestApiResultVoucher to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RestApiResultVoucher other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
