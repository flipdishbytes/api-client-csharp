...
namespace Flipdish.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class RestApiPaginationResultStore :  IEquatable<RestApiPaginationResultStore>
    {
        /// <summary>
        ...
        {
            return this.Equals(input as RestApiPaginationResultStore);
        }

        /// <summary>
        /// Returns true if RestApiPaginationResultStore instances are equal
        /// </summary>
        /// <param name="input">Instance of RestApiPaginationResultStore to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RestApiPaginationResultStore input)
        {
            if (input == null)
                return false;
