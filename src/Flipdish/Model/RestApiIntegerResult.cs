...
namespace Flipdish.Model
{
    ...
    public partial class RestApiIntegerResult :  IEquatable<RestApiIntegerResult>, IValidatableObject
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as RestApiIntegerResult);
        }

        /// <summary>
        /// Returns true if RestApiIntegerResult instances are equal
        /// </summary>
        /// <param name="other">Instance of RestApiIntegerResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RestApiIntegerResult other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
