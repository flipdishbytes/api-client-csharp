...
namespace Flipdish.Model
{
    ...
    public partial class StoreOpeningHoursUpdatedEvent :  IEquatable<StoreOpeningHoursUpdatedEvent>, IValidatableObject
    {
        ...
        public StoreOpeningHoursUpdatedEvent(int? StoreId = default(int?), UserEventInfo User = default(UserEventInfo), string Description = default(string), string EventName = default(string), Guid? FlipdishEventId = default(Guid?), DateTime? CreateTime = default(DateTime?), string Details = default(string), int? Position = default(int?))
        {
