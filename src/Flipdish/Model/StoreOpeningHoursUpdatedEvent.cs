...
namespace Flipdish.Model
{
    ...
    public partial class StoreOpeningHoursUpdatedEvent :  IEquatable<StoreOpeningHoursUpdatedEvent>, IValidatableObject
    {
        ...
        public StoreOpeningHoursUpdatedEvent(string eventName = default(string), int? storeId = default(int?), UserEventInfo user = default(UserEventInfo), string description = default(string), Guid? flipdishEventId = default(Guid?), DateTime? createTime = default(DateTime?), int? position = default(int?))
        {
