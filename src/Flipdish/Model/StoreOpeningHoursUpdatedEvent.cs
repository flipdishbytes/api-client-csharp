...
namespace Flipdish.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class StoreOpeningHoursUpdatedEvent :  IEquatable<StoreOpeningHoursUpdatedEvent>
    {
        /// <summary>
        ...
        {
            return this.Equals(input as StoreOpeningHoursUpdatedEvent);
        }

        /// <summary>
        /// Returns true if StoreOpeningHoursUpdatedEvent instances are equal
        /// </summary>
        /// <param name="input">Instance of StoreOpeningHoursUpdatedEvent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StoreOpeningHoursUpdatedEvent input)
        {
            if (input == null)
                return false;
