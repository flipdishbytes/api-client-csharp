...
namespace Flipdish.Model
{
    ...
    public partial class PrinterTurnedOnEvent :  IEquatable<PrinterTurnedOnEvent>, IValidatableObject
    {
        ...
        public PrinterTurnedOnEvent(string eventName = default(string), string description = default(string), int? storeId = default(int?), UserEventInfo user = default(UserEventInfo), Printer printer = default(Printer), Guid? flipdishEventId = default(Guid?), DateTime? createTime = default(DateTime?), int? position = default(int?), string appId = default(string))
        {
