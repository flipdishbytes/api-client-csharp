...
namespace Flipdish.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PrinterTurnedOnEvent :  IEquatable<PrinterTurnedOnEvent>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PrinterTurnedOnEvent" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as PrinterTurnedOnEvent);
        }

        /// <summary>
        /// Returns true if PrinterTurnedOnEvent instances are equal
        /// </summary>
        /// <param name="input">Instance of PrinterTurnedOnEvent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PrinterTurnedOnEvent input)
        {
            if (input == null)
                return false;
