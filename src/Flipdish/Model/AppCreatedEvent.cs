...
namespace Flipdish.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AppCreatedEvent :  IEquatable<AppCreatedEvent>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AppCreatedEvent" /> class.
        /// </summary>
        ...
        public AppCreatedEvent(string eventName = default(string), string description = default(string), string appName = default(string), string countryId = default(string), UserEventInfo user = default(UserEventInfo), string accountId = default(string), string orgId = default(string), Guid? flipdishEventId = default(Guid?), DateTime? createTime = default(DateTime?), int? position = default(int?), string appId = default(string), string ipAddress = default(string), string activityId = default(string), string activityType = default(string))
        {
        ...
        {
            return this.Equals(input as AppCreatedEvent);
        }

        /// <summary>
        /// Returns true if AppCreatedEvent instances are equal
        /// </summary>
        /// <param name="input">Instance of AppCreatedEvent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AppCreatedEvent input)
        {
            if (input == null)
                return false;
