...
{
    /// <summary>
    /// FlipdishPublicModelsV1MenusMenuSectionAvailability
    /// </summary>
    [DataContract]
    public partial class FlipdishPublicModelsV1MenusMenuSectionAvailability :  IEquatable<FlipdishPublicModelsV1MenusMenuSectionAvailability>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="FlipdishPublicModelsV1MenusMenuSectionAvailability" /> class.
        /// </summary>
        /// <param name="AvailableTimes">AvailableTimes.</param>
        /// <param name="AvailabilityMode">AvailabilityMode.</param>
        public FlipdishPublicModelsV1MenusMenuSectionAvailability(List<FlipdishPublicModelsV1BusinessHoursPeriod> AvailableTimes = default(List<FlipdishPublicModelsV1BusinessHoursPeriod>), AvailabilityModeEnum? AvailabilityMode = default(AvailabilityModeEnum?))
        {
        ...
        public List<FlipdishPublicModelsV1BusinessHoursPeriod> AvailableTimes { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class FlipdishPublicModelsV1MenusMenuSectionAvailability {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as FlipdishPublicModelsV1MenusMenuSectionAvailability);
        }

        /// <summary>
        /// Returns true if FlipdishPublicModelsV1MenusMenuSectionAvailability instances are equal
        /// </summary>
        /// <param name="other">Instance of FlipdishPublicModelsV1MenusMenuSectionAvailability to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FlipdishPublicModelsV1MenusMenuSectionAvailability other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
