...
namespace Flipdish.Model
{
    ...
    public partial class CatalogGroupUpdatedEvent :  IEquatable<CatalogGroupUpdatedEvent>, IValidatableObject
    {
        ...
        public CatalogGroupUpdatedEvent(string eventName = default(string), Guid? flipdishEventId = default(Guid?), DateTime? createTime = default(DateTime?), int? position = default(int?), string appId = default(string))
        {
