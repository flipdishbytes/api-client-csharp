...
namespace Flipdish.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ApmDataPoint :  IEquatable<ApmDataPoint>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as ApmDataPoint);
        }

        /// <summary>
        /// Returns true if ApmDataPoint instances are equal
        /// </summary>
        /// <param name="input">Instance of ApmDataPoint to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApmDataPoint input)
        {
            if (input == null)
                return false;
