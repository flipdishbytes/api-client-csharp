...
namespace Flipdish.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class RetentionCampaignUpdatedEvent :  IEquatable<RetentionCampaignUpdatedEvent>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RetentionCampaignUpdatedEvent" /> class.
        /// </summary>
        ...
        public RetentionCampaignUpdatedEvent(string eventName = default(string), string description = default(string), int? storeId = default(int?), UserEventInfo user = default(UserEventInfo), RetentionCampaign retentionCampaign = default(RetentionCampaign), Guid? flipdishEventId = default(Guid?), DateTime? createTime = default(DateTime?), int? position = default(int?), string appId = default(string), string orgId = default(string), string ipAddress = default(string), string activityId = default(string), string activityType = default(string))
        {
        ...
        {
            return this.Equals(input as RetentionCampaignUpdatedEvent);
        }

        /// <summary>
        /// Returns true if RetentionCampaignUpdatedEvent instances are equal
        /// </summary>
        /// <param name="input">Instance of RetentionCampaignUpdatedEvent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RetentionCampaignUpdatedEvent input)
        {
            if (input == null)
                return false;
