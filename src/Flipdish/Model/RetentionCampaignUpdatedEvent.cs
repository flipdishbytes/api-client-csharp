...
namespace Flipdish.Model
{
    ...
    public partial class RetentionCampaignUpdatedEvent :  IEquatable<RetentionCampaignUpdatedEvent>, IValidatableObject
    {
        ...
        public RetentionCampaignUpdatedEvent(string EventName = default(string), string Description = default(string), int? StoreId = default(int?), RetentionCampaign RetentionCampaign = default(RetentionCampaign), Guid? FlipdishEventId = default(Guid?), DateTime? CreateTime = default(DateTime?), int? Position = default(int?))
        {
