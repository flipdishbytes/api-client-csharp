...
namespace Flipdish.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class BankAccountUpdatedEvent :  IEquatable<BankAccountUpdatedEvent>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BankAccountUpdatedEvent" /> class.
        /// </summary>
        ...
        public BankAccountUpdatedEvent(string orgId = default(string), BankAccount bankAccount = default(BankAccount), UserEventInfo user = default(UserEventInfo), string eventName = default(string), Guid? flipdishEventId = default(Guid?), DateTime? createTime = default(DateTime?), int? position = default(int?), string appId = default(string), string ipAddress = default(string), string activityId = default(string), string activityType = default(string))
        {
            this.OrgId = orgId;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BankAccountUpdatedEvent {\n");
        ...
        {
            return this.Equals(input as BankAccountUpdatedEvent);
        }

        /// <summary>
        /// Returns true if BankAccountUpdatedEvent instances are equal
        /// </summary>
        /// <param name="input">Instance of BankAccountUpdatedEvent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BankAccountUpdatedEvent input)
        {
            if (input == null)
                return false;
