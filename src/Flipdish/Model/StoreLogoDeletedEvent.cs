...
namespace Flipdish.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class StoreLogoDeletedEvent :  IEquatable<StoreLogoDeletedEvent>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="StoreLogoDeletedEvent" /> class.
        /// </summary>
        ...
        /// <param name="user">User who removed the logo.</param>
        ...
        public StoreLogoDeletedEvent(string eventName = default(string), string orgId = default(string), int? storeId = default(int?), string description = default(string), UserEventInfo user = default(UserEventInfo), Guid? flipdishEventId = default(Guid?), DateTime? createTime = default(DateTime?), int? position = default(int?), string appId = default(string), string ipAddress = default(string), string activityId = default(string), string activityType = default(string))
        {
        ...
        /// </summary>
        /// <value>User who removed the logo</value>
        ...
        {
            return this.Equals(input as StoreLogoDeletedEvent);
        }

        /// <summary>
        /// Returns true if StoreLogoDeletedEvent instances are equal
        /// </summary>
        /// <param name="input">Instance of StoreLogoDeletedEvent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StoreLogoDeletedEvent input)
        {
            if (input == null)
                return false;
