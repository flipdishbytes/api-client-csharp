...
namespace Flipdish.Model
{
    ...
    public partial class Menu :  IEquatable<Menu>, IValidatableObject
    {
        ...
        public Menu(int? MenuId = default(int?), int? VersionNumber = default(int?), DateTime? ModifiedTime = default(DateTime?), List<MenuSectionBase> MenuSections = default(List<MenuSectionBase>), string ImageUrl = default(string))
        {
            this.MenuId = MenuId;
        ...
        public List<MenuSectionBase> MenuSections { get; set; }
