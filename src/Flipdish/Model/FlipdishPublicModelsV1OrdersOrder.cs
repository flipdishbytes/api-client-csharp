...
{
    /// <summary>
    /// FlipdishPublicModelsV1OrdersOrder
    /// </summary>
    [DataContract]
    public partial class FlipdishPublicModelsV1OrdersOrder :  IEquatable<FlipdishPublicModelsV1OrdersOrder>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="FlipdishPublicModelsV1OrdersOrder" /> class.
        /// </summary>
        ...
        public FlipdishPublicModelsV1OrdersOrder(int? OrderId = default(int?), FlipdishPublicModelsV1StoresStoreSummary Store = default(FlipdishPublicModelsV1StoresStoreSummary), FlipdishPublicModelsV1CustomersCustomerSummary Customer = default(FlipdishPublicModelsV1CustomersCustomerSummary), FlipdishPublicModelsV1VouchersVoucherSummary Voucher = default(FlipdishPublicModelsV1VouchersVoucherSummary), FlipdishPublicModelsV1FeesFeeSummary Fees = default(FlipdishPublicModelsV1FeesFeeSummary), DeliveryTypeEnum? DeliveryType = default(DeliveryTypeEnum?), PickupLocationTypeEnum? PickupLocationType = default(PickupLocationTypeEnum?), List<FlipdishPublicModelsV1OrdersOrderItem> OrderItems = default(List<FlipdishPublicModelsV1OrdersOrderItem>), double? TipAmount = default(double?), double? DeliveryAmount = default(double?), double? OrderItemsAmount = default(double?), double? Amount = default(double?), double? ProcessingFee = default(double?), PaymentAccountTypeEnum? PaymentAccountType = default(PaymentAccountTypeEnum?), string PaymentAccountDescription = default(string), FlipdishPublicModelsV1DeliveryLocation DeliveryLocation = default(FlipdishPublicModelsV1DeliveryLocation), FlipdishPublicModelsV1Coordinates CustomerLocation = default(FlipdishPublicModelsV1Coordinates), OrderStateEnum? OrderState = default(OrderStateEnum?), bool? IsPreOrder = default(bool?), DateTime? PlacedTime = default(DateTime?), DateTime? RequestedForTime = default(DateTime?), string ChefNote = default(string), AppTypeEnum? AppType = default(AppTypeEnum?), int? UserRating = default(int?))
        {
        ...
        public FlipdishPublicModelsV1StoresStoreSummary Store { get; set; }

        /// <summary>
        /// Gets or Sets Customer
        /// </summary>
        [DataMember(Name="customer", EmitDefaultValue=false)]
        public FlipdishPublicModelsV1CustomersCustomerSummary Customer { get; set; }

        /// <summary>
        /// Gets or Sets Voucher
        /// </summary>
        [DataMember(Name="voucher", EmitDefaultValue=false)]
        public FlipdishPublicModelsV1VouchersVoucherSummary Voucher { get; set; }

        /// <summary>
        /// Gets or Sets Fees
        /// </summary>
        [DataMember(Name="fees", EmitDefaultValue=false)]
        public FlipdishPublicModelsV1FeesFeeSummary Fees { get; set; }
        ...
        public List<FlipdishPublicModelsV1OrdersOrderItem> OrderItems { get; set; }
        ...
        public FlipdishPublicModelsV1DeliveryLocation DeliveryLocation { get; set; }

        /// <summary>
        /// Gets or Sets CustomerLocation
        /// </summary>
        [DataMember(Name="customerLocation", EmitDefaultValue=false)]
        public FlipdishPublicModelsV1Coordinates CustomerLocation { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class FlipdishPublicModelsV1OrdersOrder {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as FlipdishPublicModelsV1OrdersOrder);
        }

        /// <summary>
        /// Returns true if FlipdishPublicModelsV1OrdersOrder instances are equal
        /// </summary>
        /// <param name="other">Instance of FlipdishPublicModelsV1OrdersOrder to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FlipdishPublicModelsV1OrdersOrder other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
