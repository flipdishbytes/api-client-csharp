...
namespace Flipdish.Model
{
    ...
    public partial class RestApiPaginationResultOrder :  IEquatable<RestApiPaginationResultOrder>, IValidatableObject
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as RestApiPaginationResultOrder);
        }

        /// <summary>
        /// Returns true if RestApiPaginationResultOrder instances are equal
        /// </summary>
        /// <param name="other">Instance of RestApiPaginationResultOrder to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RestApiPaginationResultOrder other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
