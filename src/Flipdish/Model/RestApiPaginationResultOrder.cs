...
namespace Flipdish.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class RestApiPaginationResultOrder :  IEquatable<RestApiPaginationResultOrder>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as RestApiPaginationResultOrder);
        }

        /// <summary>
        /// Returns true if RestApiPaginationResultOrder instances are equal
        /// </summary>
        /// <param name="input">Instance of RestApiPaginationResultOrder to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RestApiPaginationResultOrder input)
        {
            if (input == null)
                return false;
