...
namespace Flipdish.Model
{
    ...
    public partial class PushNotificationDeletedEvent :  IEquatable<PushNotificationDeletedEvent>
    {
        ...
        public PushNotificationDeletedEvent(string eventName = default(string), string description = default(string), PushNotificationRequest pushNotification = default(PushNotificationRequest), Guid? flipdishEventId = default(Guid?), DateTime? createTime = default(DateTime?), int? position = default(int?), string appId = default(string), string orgId = default(string), string ipAddress = default(string))
        {
