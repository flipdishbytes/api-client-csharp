...
namespace Flipdish.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PushNotificationDeletedEvent :  IEquatable<PushNotificationDeletedEvent>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PushNotificationDeletedEvent" /> class.
        /// </summary>
        ...
        public PushNotificationDeletedEvent(string eventName = default(string), string description = default(string), PushNotificationRequest pushNotification = default(PushNotificationRequest), Guid? flipdishEventId = default(Guid?), DateTime? createTime = default(DateTime?), int? position = default(int?), string appId = default(string), string orgId = default(string), string ipAddress = default(string), string activityId = default(string), string activityType = default(string))
        {
        ...
        {
            return this.Equals(input as PushNotificationDeletedEvent);
        }

        /// <summary>
        /// Returns true if PushNotificationDeletedEvent instances are equal
        /// </summary>
        /// <param name="input">Instance of PushNotificationDeletedEvent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PushNotificationDeletedEvent input)
        {
            if (input == null)
                return false;
