...
namespace Flipdish.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class StoreLogoUpdatedEvent :  IEquatable<StoreLogoUpdatedEvent>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="StoreLogoUpdatedEvent" /> class.
        /// </summary>
        ...
        /// <param name="user">User who updated the logo.</param>
        ...
        public StoreLogoUpdatedEvent(string eventName = default(string), string orgId = default(string), int? storeId = default(int?), string logoUrl = default(string), string description = default(string), UserEventInfo user = default(UserEventInfo), Guid? flipdishEventId = default(Guid?), DateTime? createTime = default(DateTime?), int? position = default(int?), string appId = default(string), string ipAddress = default(string), string activityId = default(string), string activityType = default(string))
        {
        ...
        /// </summary>
        /// <value>User who updated the logo</value>
        ...
        {
            return this.Equals(input as StoreLogoUpdatedEvent);
        }

        /// <summary>
        /// Returns true if StoreLogoUpdatedEvent instances are equal
        /// </summary>
        /// <param name="input">Instance of StoreLogoUpdatedEvent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StoreLogoUpdatedEvent input)
        {
            if (input == null)
                return false;
