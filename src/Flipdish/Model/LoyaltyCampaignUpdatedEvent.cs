...
namespace Flipdish.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class LoyaltyCampaignUpdatedEvent :  IEquatable<LoyaltyCampaignUpdatedEvent>
    {
        /// <summary>
        ...
        public LoyaltyCampaignUpdatedEvent(string eventName = default(string), string description = default(string), int? storeId = default(int?), UserEventInfo user = default(UserEventInfo), LoyaltyCampaign loyaltyCampaign = default(LoyaltyCampaign), Guid? flipdishEventId = default(Guid?), DateTime? createTime = default(DateTime?), int? position = default(int?), string appId = default(string), string orgId = default(string), string ipAddress = default(string), string activityId = default(string), string activityType = default(string))
        {
