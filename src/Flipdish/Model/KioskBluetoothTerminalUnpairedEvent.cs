...
namespace Flipdish.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class KioskBluetoothTerminalUnpairedEvent :  IEquatable<KioskBluetoothTerminalUnpairedEvent>, IValidatableObject
    {
        /// <summary>
        /// Terminal Type
        /// </summary>
        ...
        public KioskBluetoothTerminalUnpairedEvent(string deviceId = default(string), BluetoothTerminalTypeEnum? bluetoothTerminalType = default(BluetoothTerminalTypeEnum?), UserEventInfo user = default(UserEventInfo), string eventName = default(string), Guid? flipdishEventId = default(Guid?), DateTime? createTime = default(DateTime?), int? position = default(int?), string appId = default(string))
        {
