...
namespace Flipdish.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class KioskBluetoothTerminalUnpairedEvent :  IEquatable<KioskBluetoothTerminalUnpairedEvent>
    {
        /// <summary>
        /// Terminal Type
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="KioskBluetoothTerminalUnpairedEvent" /> class.
        /// </summary>
        ...
        public KioskBluetoothTerminalUnpairedEvent(string deviceId = default(string), BluetoothTerminalTypeEnum? bluetoothTerminalType = default(BluetoothTerminalTypeEnum?), UserEventInfo user = default(UserEventInfo), string eventName = default(string), Guid? flipdishEventId = default(Guid?), DateTime? createTime = default(DateTime?), int? position = default(int?), string appId = default(string), string orgId = default(string), string ipAddress = default(string), string activityId = default(string), string activityType = default(string))
        {
        ...
        {
            return this.Equals(input as KioskBluetoothTerminalUnpairedEvent);
        }

        /// <summary>
        /// Returns true if KioskBluetoothTerminalUnpairedEvent instances are equal
        /// </summary>
        /// <param name="input">Instance of KioskBluetoothTerminalUnpairedEvent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(KioskBluetoothTerminalUnpairedEvent input)
        {
            if (input == null)
                return false;
