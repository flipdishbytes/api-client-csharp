...
namespace Flipdish.Model
{
    ...
    public partial class Voucher :  IEquatable<Voucher>, IValidatableObject
    {
        ...
        public Voucher(int? voucherId = default(int?), string code = default(string), StatusEnum? status = default(StatusEnum?), VoucherTypeEnum? voucherType = default(VoucherTypeEnum?), VoucherSubTypeEnum? voucherSubType = default(VoucherSubTypeEnum?), DateTime? startDate = default(DateTime?), AddItemDetails addItemDetails = default(AddItemDetails), CreditNoteDetails creditNoteDetails = default(CreditNoteDetails), LumpDiscountDetails lumpDiscountDetails = default(LumpDiscountDetails), PercentDiscountDetails percentDiscountDetails = default(PercentDiscountDetails), CurrencyEnum? currency = default(CurrencyEnum?), string description = default(string), bool? isEnabled = default(bool?), DateTime? expiryDate = default(DateTime?))
        {
