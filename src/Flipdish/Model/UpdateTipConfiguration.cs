...
namespace Flipdish.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class UpdateTipConfiguration :  IEquatable<UpdateTipConfiguration>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateTipConfiguration" /> class.
        /// </summary>
        ...
        public UpdateTipConfiguration(bool? isEnabled = default(bool?), bool? allowCustomTips = default(bool?), bool? allowRoundUp = default(bool?), bool? allowEmojis = default(bool?), List<double?> percentages = default(List<double?>), double? defaultPercentage = default(double?))
        {
        ...
        {
            return this.Equals(input as UpdateTipConfiguration);
        }

        /// <summary>
        /// Returns true if UpdateTipConfiguration instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdateTipConfiguration to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdateTipConfiguration input)
        {
            if (input == null)
                return false;
