...
namespace Flipdish.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TeammateUpdatedEvent :  IEquatable<TeammateUpdatedEvent>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TeammateUpdatedEvent" /> class.
        /// </summary>
        /// <param name="teammate">The deleted teammate.</param>
        /// <param name="user">User who updated the teammate.</param>
        ...
        public TeammateUpdatedEvent(Teammate teammate = default(Teammate), UserEventInfo user = default(UserEventInfo), string eventName = default(string), Guid? flipdishEventId = default(Guid?), DateTime? createTime = default(DateTime?), int? position = default(int?), string appId = default(string), string orgId = default(string), string ipAddress = default(string), string activityId = default(string), string activityType = default(string))
        {
        ...
        /// </summary>
        /// <value>User who updated the teammate</value>
        ...
        {
            return this.Equals(input as TeammateUpdatedEvent);
        }

        /// <summary>
        /// Returns true if TeammateUpdatedEvent instances are equal
        /// </summary>
        /// <param name="input">Instance of TeammateUpdatedEvent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TeammateUpdatedEvent input)
        {
            if (input == null)
                return false;
