...
namespace Flipdish.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AppStoreConfigUpdatedEvent :  IEquatable<AppStoreConfigUpdatedEvent>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AppStoreConfigUpdatedEvent" /> class.
        /// </summary>
        /// <param name="eventName">The event name.</param>
        /// <param name="appStoreAppId">App Store Id.</param>
        /// <param name="appStoreAppConfiguration">App Configuration.</param>
        /// <param name="user">User who has update the configuration.</param>
        ...
        public AppStoreConfigUpdatedEvent(string eventName = default(string), string appStoreAppId = default(string), UpdateAppStoreAppConfigurationWebhookDTO appStoreAppConfiguration = default(UpdateAppStoreAppConfigurationWebhookDTO), UserEventInfo user = default(UserEventInfo), Guid? flipdishEventId = default(Guid?), DateTime? createTime = default(DateTime?), int? position = default(int?), string appId = default(string), string orgId = default(string), string ipAddress = default(string), string activityId = default(string), string activityType = default(string))
        {
        ...
        public UpdateAppStoreAppConfigurationWebhookDTO AppStoreAppConfiguration { get; set; }

        /// <summary>
        /// User who has update the configuration
        /// </summary>
        /// <value>User who has update the configuration</value>
        ...
        {
            return this.Equals(input as AppStoreConfigUpdatedEvent);
        }

        /// <summary>
        /// Returns true if AppStoreConfigUpdatedEvent instances are equal
        /// </summary>
        /// <param name="input">Instance of AppStoreConfigUpdatedEvent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AppStoreConfigUpdatedEvent input)
        {
            if (input == null)
                return false;
