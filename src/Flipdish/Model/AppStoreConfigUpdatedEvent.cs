...
namespace Flipdish.Model
{
    ...
    public partial class AppStoreConfigUpdatedEvent :  IEquatable<AppStoreConfigUpdatedEvent>, IValidatableObject
    {
        ...
        public AppStoreConfigUpdatedEvent(string eventName = default(string), string appStoreAppId = default(string), UpdateAppStoreAppConfigurationWebhookDTO updateAppStoreAppStoreAppStoreAppConfiguration = default(UpdateAppStoreAppConfigurationWebhookDTO), Guid? flipdishEventId = default(Guid?), DateTime? createTime = default(DateTime?), int? position = default(int?), string appId = default(string), string ipAddress = default(string))
        {
