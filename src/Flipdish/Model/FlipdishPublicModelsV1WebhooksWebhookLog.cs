...
{
    /// <summary>
    /// FlipdishPublicModelsV1WebhooksWebhookLog
    /// </summary>
    [DataContract]
    public partial class FlipdishPublicModelsV1WebhooksWebhookLog :  IEquatable<FlipdishPublicModelsV1WebhooksWebhookLog>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FlipdishPublicModelsV1WebhooksWebhookLog" /> class.
        /// </summary>
        ...
        public FlipdishPublicModelsV1WebhooksWebhookLog(int? WebhookSubscriptionOwnerUserId = default(int?), string EventCreated = default(string), string WebhookTriggered = default(string), string WebhookEventName = default(string), string WebhookSubscriptionCallbackUrl = default(string), string HttpResponseStatusCode = default(string), string HttpResponseStatus = default(string), string RequestHeaders = default(string), string RequestBody = default(string), string ResponseHeaders = default(string), string ResponseBody = default(string), string Duration = default(string), int? RetryCount = default(int?), Guid? FlipdishWebhookId = default(Guid?))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class FlipdishPublicModelsV1WebhooksWebhookLog {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as FlipdishPublicModelsV1WebhooksWebhookLog);
        }

        /// <summary>
        /// Returns true if FlipdishPublicModelsV1WebhooksWebhookLog instances are equal
        /// </summary>
        /// <param name="other">Instance of FlipdishPublicModelsV1WebhooksWebhookLog to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FlipdishPublicModelsV1WebhooksWebhookLog other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
