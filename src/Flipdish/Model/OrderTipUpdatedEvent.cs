...
namespace Flipdish.Model
{
    ...
    public partial class OrderTipUpdatedEvent :  IEquatable<OrderTipUpdatedEvent>, IValidatableObject
    {
        ...
        public OrderTipUpdatedEvent(double? NewTipAmount = default(double?), string Description = default(string), Order Order = default(Order), string EventName = default(string), Guid? FlipdishEventId = default(Guid?), DateTime? CreateTime = default(DateTime?), int? Position = default(int?))
        {
