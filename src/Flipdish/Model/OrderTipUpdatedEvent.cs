...
namespace Flipdish.Model
{
    ...
    public partial class OrderTipUpdatedEvent :  IEquatable<OrderTipUpdatedEvent>, IValidatableObject
    {
        ...
        public OrderTipUpdatedEvent(string eventName = default(string), double? tipAmount = default(double?), string description = default(string), Order order = default(Order), Guid? flipdishEventId = default(Guid?), DateTime? createTime = default(DateTime?), int? position = default(int?), string appId = default(string), string ipAddress = default(string))
        {
