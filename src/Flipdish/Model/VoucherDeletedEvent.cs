...
namespace Flipdish.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class VoucherDeletedEvent :  IEquatable<VoucherDeletedEvent>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="VoucherDeletedEvent" /> class.
        /// </summary>
        /// <param name="voucherId">Voucher Id.</param>
        /// <param name="eventName">The event name.</param>
        /// <param name="user">User which deleted this voucher.</param>
        /// <param name="description">Description.</param>
        /// <param name="voucher">Deleted voucher.</param>
        ...
        public VoucherDeletedEvent(int? voucherId = default(int?), string eventName = default(string), UserEventInfo user = default(UserEventInfo), string description = default(string), Voucher voucher = default(Voucher), Guid? flipdishEventId = default(Guid?), DateTime? createTime = default(DateTime?), int? position = default(int?), string appId = default(string), string orgId = default(string), string ipAddress = default(string), string activityId = default(string), string activityType = default(string))
        {
        ...
        /// </summary>
        /// <value>User which deleted this voucher</value>
        ...
        {
            return this.Equals(input as VoucherDeletedEvent);
        }

        /// <summary>
        /// Returns true if VoucherDeletedEvent instances are equal
        /// </summary>
        /// <param name="input">Instance of VoucherDeletedEvent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(VoucherDeletedEvent input)
        {
            if (input == null)
                return false;
