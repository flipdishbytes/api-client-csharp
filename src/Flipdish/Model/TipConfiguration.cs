...
namespace Flipdish.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TipConfiguration :  IEquatable<TipConfiguration>, IValidatableObject
    {
        /// <summary>
        ...
        public TipConfiguration(int? storeId = default(int?), bool? isEnabled = default(bool?), bool? allowCustomTips = default(bool?), List<double?> percentages = default(List<double?>), double? defaultPercentage = default(double?))
        {
