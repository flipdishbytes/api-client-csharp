...
namespace Flipdish.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class MenuSectionDeletedEvent :  IEquatable<MenuSectionDeletedEvent>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MenuSectionDeletedEvent" /> class.
        /// </summary>
        /// <param name="menuId">Menu identifier.</param>
        /// <param name="description">Description.</param>
        /// <param name="user">User who has created the menu.</param>
        /// <param name="menuSection">Deleted menu section.</param>
        ...
        public MenuSectionDeletedEvent(int? menuId = default(int?), string description = default(string), UserEventInfo user = default(UserEventInfo), MenuSection menuSection = default(MenuSection), string eventName = default(string), Guid? flipdishEventId = default(Guid?), DateTime? createTime = default(DateTime?), int? position = default(int?), string appId = default(string), string orgId = default(string), string ipAddress = default(string), string activityId = default(string), string activityType = default(string))
        {
            this.MenuId = menuId;
        ...
        /// </summary>
        /// <value>Deleted menu section</value>
        ...
        {
            return this.Equals(input as MenuSectionDeletedEvent);
        }

        /// <summary>
        /// Returns true if MenuSectionDeletedEvent instances are equal
        /// </summary>
        /// <param name="input">Instance of MenuSectionDeletedEvent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MenuSectionDeletedEvent input)
        {
            if (input == null)
                return false;
