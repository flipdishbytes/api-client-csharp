...
namespace Flipdish.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class VoucherCreatedEvent :  IEquatable<VoucherCreatedEvent>
    {
        /// <summary>
        ...
        public VoucherCreatedEvent(int? voucherId = default(int?), string eventName = default(string), UserEventInfo user = default(UserEventInfo), string description = default(string), Voucher voucher = default(Voucher), Guid? flipdishEventId = default(Guid?), DateTime? createTime = default(DateTime?), int? position = default(int?), string appId = default(string), string orgId = default(string), string ipAddress = default(string), string activityId = default(string), string activityType = default(string))
        {
