...
namespace Flipdish.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TeammateInviteAcceptedEvent :  IEquatable<TeammateInviteAcceptedEvent>
    {
        /// <summary>
        ...
        {
            return this.Equals(input as TeammateInviteAcceptedEvent);
        }

        /// <summary>
        /// Returns true if TeammateInviteAcceptedEvent instances are equal
        /// </summary>
        /// <param name="input">Instance of TeammateInviteAcceptedEvent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TeammateInviteAcceptedEvent input)
        {
            if (input == null)
                return false;
