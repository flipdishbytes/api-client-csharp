...
namespace Flipdish.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PhoneCallEndedEvent :  IEquatable<PhoneCallEndedEvent>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PhoneCallEndedEvent" /> class.
        /// </summary>
        ...
        public PhoneCallEndedEvent(string eventName = default(string), string description = default(string), int? storeId = default(int?), PhoneCall phoneCall = default(PhoneCall), Guid? flipdishEventId = default(Guid?), DateTime? createTime = default(DateTime?), int? position = default(int?), string appId = default(string), string orgId = default(string), string ipAddress = default(string), string activityId = default(string), string activityType = default(string))
        {
        ...
        {
            return this.Equals(input as PhoneCallEndedEvent);
        }

        /// <summary>
        /// Returns true if PhoneCallEndedEvent instances are equal
        /// </summary>
        /// <param name="input">Instance of PhoneCallEndedEvent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PhoneCallEndedEvent input)
        {
            if (input == null)
                return false;
