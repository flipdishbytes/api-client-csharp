...
namespace Flipdish.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TeammateDeletedEvent :  IEquatable<TeammateDeletedEvent>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TeammateDeletedEvent" /> class.
        /// </summary>
        /// <param name="teammate">The deleted teammate.</param>
        /// <param name="user">User who deleted the teammate.</param>
        ...
        /// </summary>
        /// <value>User who deleted the teammate</value>
        ...
        {
            return this.Equals(input as TeammateDeletedEvent);
        }

        /// <summary>
        /// Returns true if TeammateDeletedEvent instances are equal
        /// </summary>
        /// <param name="input">Instance of TeammateDeletedEvent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TeammateDeletedEvent input)
        {
            if (input == null)
                return false;
