...
namespace Flipdish.Model
{
    ...
    public partial class TeammateDeletedEvent :  IEquatable<TeammateDeletedEvent>, IValidatableObject
    {
        ...
        public TeammateDeletedEvent(Teammate teammate = default(Teammate), UserEventInfo user = default(UserEventInfo), string eventName = default(string), Guid? flipdishEventId = default(Guid?), DateTime? createTime = default(DateTime?), int? position = default(int?), string appId = default(string))
        {
