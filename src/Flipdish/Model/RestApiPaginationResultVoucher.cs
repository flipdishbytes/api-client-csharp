...
namespace Flipdish.Model
{
    ...
    public partial class RestApiPaginationResultVoucher :  IEquatable<RestApiPaginationResultVoucher>, IValidatableObject
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as RestApiPaginationResultVoucher);
        }

        /// <summary>
        /// Returns true if RestApiPaginationResultVoucher instances are equal
        /// </summary>
        /// <param name="other">Instance of RestApiPaginationResultVoucher to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RestApiPaginationResultVoucher other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
