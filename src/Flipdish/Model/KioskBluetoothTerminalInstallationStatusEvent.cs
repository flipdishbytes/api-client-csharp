...
namespace Flipdish.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class KioskBluetoothTerminalInstallationStatusEvent :  IEquatable<KioskBluetoothTerminalInstallationStatusEvent>
    {
        /// <summary>
        /// Terminal Type
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="KioskBluetoothTerminalInstallationStatusEvent" /> class.
        /// </summary>
        ...
        /// <param name="progress">Update Install Progress for Card Reader.</param>
        ...
        public KioskBluetoothTerminalInstallationStatusEvent(string deviceId = default(string), BluetoothTerminalTypeEnum? bluetoothTerminalType = default(BluetoothTerminalTypeEnum?), string bluetoothTerminalSerialNumber = default(string), UserEventInfo user = default(UserEventInfo), int? progress = default(int?), string eventName = default(string), Guid? flipdishEventId = default(Guid?), DateTime? createTime = default(DateTime?), int? position = default(int?), string appId = default(string), string orgId = default(string), string ipAddress = default(string), string activityId = default(string), string activityType = default(string))
        {
        ...
        /// </summary>
        /// <value>Update Install Progress for Card Reader</value>
        ...
        {
            return this.Equals(input as KioskBluetoothTerminalInstallationStatusEvent);
        }

        /// <summary>
        /// Returns true if KioskBluetoothTerminalInstallationStatusEvent instances are equal
        /// </summary>
        /// <param name="input">Instance of KioskBluetoothTerminalInstallationStatusEvent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(KioskBluetoothTerminalInstallationStatusEvent input)
        {
            if (input == null)
                return false;
