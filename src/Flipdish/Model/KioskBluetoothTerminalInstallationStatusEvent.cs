...
namespace Flipdish.Model
{
    ...
    public partial class KioskBluetoothTerminalInstallationStatusEvent :  IEquatable<KioskBluetoothTerminalInstallationStatusEvent>, IValidatableObject
    {
        ...
        public KioskBluetoothTerminalInstallationStatusEvent(string deviceId = default(string), BluetoothTerminalTypeEnum? bluetoothTerminalType = default(BluetoothTerminalTypeEnum?), string bluetoothTerminalSerialNumber = default(string), UserEventInfo user = default(UserEventInfo), int? progress = default(int?), string eventName = default(string), Guid? flipdishEventId = default(Guid?), DateTime? createTime = default(DateTime?), int? position = default(int?), string appId = default(string))
        {
