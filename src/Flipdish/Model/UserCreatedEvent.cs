...
namespace Flipdish.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class UserCreatedEvent :  IEquatable<UserCreatedEvent>
    {
        /// <summary>
        ...
        public UserCreatedEvent(string eventName = default(string), string description = default(string), UserEventInfo user = default(UserEventInfo), Guid? flipdishEventId = default(Guid?), DateTime? createTime = default(DateTime?), int? position = default(int?), string appId = default(string), string orgId = default(string), string ipAddress = default(string), string activityId = default(string), string activityType = default(string))
        {
        ...
        {
            return this.Equals(input as UserCreatedEvent);
        }

        /// <summary>
        /// Returns true if UserCreatedEvent instances are equal
        /// </summary>
        /// <param name="input">Instance of UserCreatedEvent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UserCreatedEvent input)
        {
            if (input == null)
                return false;
