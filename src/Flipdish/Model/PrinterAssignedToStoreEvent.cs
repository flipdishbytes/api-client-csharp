...
namespace Flipdish.Model
{
    ...
    public partial class PrinterAssignedToStoreEvent :  IEquatable<PrinterAssignedToStoreEvent>, IValidatableObject
    {
        ...
        public PrinterAssignedToStoreEvent(string eventName = default(string), string description = default(string), int? storeId = default(int?), UserEventInfo user = default(UserEventInfo), Printer printer = default(Printer), Guid? flipdishEventId = default(Guid?), DateTime? createTime = default(DateTime?), int? position = default(int?), string appId = default(string))
        {
