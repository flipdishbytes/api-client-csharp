...
namespace Flipdish.Model
{
    ...
    public partial class PrinterAssignedToStoreEvent :  IEquatable<PrinterAssignedToStoreEvent>, IValidatableObject
    {
        ...
        public PrinterAssignedToStoreEvent(string EventName = default(string), string Description = default(string), int? StoreId = default(int?), Printer Printer = default(Printer), Guid? FlipdishEventId = default(Guid?), DateTime? CreateTime = default(DateTime?), int? Position = default(int?))
        {
