...
namespace Flipdish.Model
{
    ...
    public partial class CatalogGroupArchivedEvent :  IEquatable<CatalogGroupArchivedEvent>
    {
        ...
        public CatalogGroupArchivedEvent(string eventName = default(string), string description = default(string), UserEventInfo user = default(UserEventInfo), Group group = default(Group), Guid? flipdishEventId = default(Guid?), DateTime? createTime = default(DateTime?), int? position = default(int?), string appId = default(string), string orgId = default(string), string ipAddress = default(string))
        {
