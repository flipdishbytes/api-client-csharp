...
namespace Flipdish.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CatalogGroupArchivedEvent :  IEquatable<CatalogGroupArchivedEvent>
    {
        /// <summary>
        ...
        public CatalogGroupArchivedEvent(string eventName = default(string), string description = default(string), UserEventInfo user = default(UserEventInfo), Group group = default(Group), Guid? flipdishEventId = default(Guid?), DateTime? createTime = default(DateTime?), int? position = default(int?), string appId = default(string), string orgId = default(string), string ipAddress = default(string), string activityId = default(string), string activityType = default(string))
        {
        ...
        {
            return this.Equals(input as CatalogGroupArchivedEvent);
        }

        /// <summary>
        /// Returns true if CatalogGroupArchivedEvent instances are equal
        /// </summary>
        /// <param name="input">Instance of CatalogGroupArchivedEvent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CatalogGroupArchivedEvent input)
        {
            if (input == null)
                return false;
