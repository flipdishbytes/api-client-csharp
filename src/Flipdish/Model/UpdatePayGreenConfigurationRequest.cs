...
namespace Flipdish.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class UpdatePayGreenConfigurationRequest :  IEquatable<UpdatePayGreenConfigurationRequest>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as UpdatePayGreenConfigurationRequest);
        }

        /// <summary>
        /// Returns true if UpdatePayGreenConfigurationRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdatePayGreenConfigurationRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdatePayGreenConfigurationRequest input)
        {
            if (input == null)
                return false;
