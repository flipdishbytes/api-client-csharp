...
namespace Flipdish.Model
{
    ...
    public partial class TeammateInviteSentEvent :  IEquatable<TeammateInviteSentEvent>, IValidatableObject
    {
        ...
        public TeammateInviteSentEvent(Teammate teammate = default(Teammate), string eventName = default(string), Guid? flipdishEventId = default(Guid?), DateTime? createTime = default(DateTime?), int? position = default(int?), string appId = default(string))
        {
