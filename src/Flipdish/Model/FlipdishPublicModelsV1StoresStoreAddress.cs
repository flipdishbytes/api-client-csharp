...
{
    /// <summary>
    /// FlipdishPublicModelsV1StoresStoreAddress
    /// </summary>
    [DataContract]
    public partial class FlipdishPublicModelsV1StoresStoreAddress :  IEquatable<FlipdishPublicModelsV1StoresStoreAddress>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FlipdishPublicModelsV1StoresStoreAddress" /> class.
        /// </summary>
        ...
        public FlipdishPublicModelsV1StoresStoreAddress(int? AddressId = default(int?), string Line1 = default(string), string Postcode = default(string), string City = default(string), string CountryCode = default(string), string DisplayForCustomer = default(string), FlipdishPublicModelsV1Coordinates Coordinates = default(FlipdishPublicModelsV1Coordinates))
        {
        ...
        public FlipdishPublicModelsV1Coordinates Coordinates { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class FlipdishPublicModelsV1StoresStoreAddress {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as FlipdishPublicModelsV1StoresStoreAddress);
        }

        /// <summary>
        /// Returns true if FlipdishPublicModelsV1StoresStoreAddress instances are equal
        /// </summary>
        /// <param name="other">Instance of FlipdishPublicModelsV1StoresStoreAddress to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FlipdishPublicModelsV1StoresStoreAddress other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
