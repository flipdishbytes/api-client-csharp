...
namespace Flipdish.Model
{
    ...
    public partial class MenuItemOptionSet :  IEquatable<MenuItemOptionSet>, IValidatableObject
    {
        ...
        public MenuItemOptionSet(int? MenuItemOptionSetId = default(int?), List<MenuItemOptionSetItem> MenuItemOptionSetItems = default(List<MenuItemOptionSetItem>), string Name = default(string), bool? IsMasterOptionSet = default(bool?), int? DisplayOrder = default(int?), int? MinSelectCount = default(int?), int? MaxSelectCount = default(int?), string ImageUrl = default(string), CellLayoutTypeEnum? CellLayoutType = default(CellLayoutTypeEnum?))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as MenuItemOptionSet);
        }

        /// <summary>
        /// Returns true if MenuItemOptionSet instances are equal
        /// </summary>
        /// <param name="other">Instance of MenuItemOptionSet to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MenuItemOptionSet other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
