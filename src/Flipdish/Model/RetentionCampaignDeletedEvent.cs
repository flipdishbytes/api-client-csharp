...
namespace Flipdish.Model
{
    ...
    public partial class RetentionCampaignDeletedEvent :  IEquatable<RetentionCampaignDeletedEvent>
    {
        ...
        public RetentionCampaignDeletedEvent(string eventName = default(string), string description = default(string), int? storeId = default(int?), UserEventInfo user = default(UserEventInfo), RetentionCampaign retentionCampaign = default(RetentionCampaign), Guid? flipdishEventId = default(Guid?), DateTime? createTime = default(DateTime?), int? position = default(int?), string appId = default(string), string orgId = default(string), string ipAddress = default(string))
        {
