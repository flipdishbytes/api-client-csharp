...
namespace Flipdish.Model
{
    ...
    public partial class RetentionCampaignDeletedEvent :  IEquatable<RetentionCampaignDeletedEvent>, IValidatableObject
    {
        ...
        public RetentionCampaignDeletedEvent(string EventName = default(string), string Description = default(string), int? StoreId = default(int?), UserEventInfo User = default(UserEventInfo), RetentionCampaign RetentionCampaign = default(RetentionCampaign), Guid? FlipdishEventId = default(Guid?), DateTime? CreateTime = default(DateTime?), int? Position = default(int?))
        {
