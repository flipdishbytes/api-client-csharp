...
namespace Flipdish.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class RetentionCampaignDeletedEvent :  IEquatable<RetentionCampaignDeletedEvent>
    {
        /// <summary>
        ...
        public RetentionCampaignDeletedEvent(string eventName = default(string), string description = default(string), int? storeId = default(int?), UserEventInfo user = default(UserEventInfo), RetentionCampaign retentionCampaign = default(RetentionCampaign), Guid? flipdishEventId = default(Guid?), DateTime? createTime = default(DateTime?), int? position = default(int?), string appId = default(string), string orgId = default(string), string ipAddress = default(string), string activityId = default(string), string activityType = default(string))
        {
        ...
        {
            return this.Equals(input as RetentionCampaignDeletedEvent);
        }

        /// <summary>
        /// Returns true if RetentionCampaignDeletedEvent instances are equal
        /// </summary>
        /// <param name="input">Instance of RetentionCampaignDeletedEvent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RetentionCampaignDeletedEvent input)
        {
            if (input == null)
                return false;
