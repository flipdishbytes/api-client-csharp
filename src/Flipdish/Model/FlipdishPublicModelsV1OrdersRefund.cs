...
{
    /// <summary>
    /// FlipdishPublicModelsV1OrdersRefund
    /// </summary>
    [DataContract]
    public partial class FlipdishPublicModelsV1OrdersRefund :  IEquatable<FlipdishPublicModelsV1OrdersRefund>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FlipdishPublicModelsV1OrdersRefund" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected FlipdishPublicModelsV1OrdersRefund() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="FlipdishPublicModelsV1OrdersRefund" /> class.
        /// </summary>
        ...
        public FlipdishPublicModelsV1OrdersRefund(string RefundReason = default(string), double? RefundAmount = default(double?), bool? NotifyCustomer = default(bool?))
        {
            // to ensure "RefundAmount" is required (not null)
            if (RefundAmount == null)
            {
                throw new InvalidDataException("RefundAmount is a required property for FlipdishPublicModelsV1OrdersRefund and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("NotifyCustomer is a required property for FlipdishPublicModelsV1OrdersRefund and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class FlipdishPublicModelsV1OrdersRefund {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as FlipdishPublicModelsV1OrdersRefund);
        }

        /// <summary>
        /// Returns true if FlipdishPublicModelsV1OrdersRefund instances are equal
        /// </summary>
        /// <param name="other">Instance of FlipdishPublicModelsV1OrdersRefund to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FlipdishPublicModelsV1OrdersRefund other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
