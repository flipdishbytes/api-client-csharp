...
namespace Flipdish.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class RestApiPaginationResultApp :  IEquatable<RestApiPaginationResultApp>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as RestApiPaginationResultApp);
        }

        /// <summary>
        /// Returns true if RestApiPaginationResultApp instances are equal
        /// </summary>
        /// <param name="input">Instance of RestApiPaginationResultApp to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RestApiPaginationResultApp input)
        {
            if (input == null)
                return false;
