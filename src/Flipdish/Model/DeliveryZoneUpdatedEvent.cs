...
namespace Flipdish.Model
{
    ...
    public partial class DeliveryZoneUpdatedEvent :  IEquatable<DeliveryZoneUpdatedEvent>, IValidatableObject
    {
        ...
        public DeliveryZoneUpdatedEvent(string eventName = default(string), int? storeId = default(int?), UserEventInfo user = default(UserEventInfo), string description = default(string), DeliveryZone deliveryZone = default(DeliveryZone), Guid? flipdishEventId = default(Guid?), DateTime? createTime = default(DateTime?), int? position = default(int?), string appId = default(string))
        {
