...
namespace Flipdish.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DeliveryZoneUpdatedEvent :  IEquatable<DeliveryZoneUpdatedEvent>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DeliveryZoneUpdatedEvent" /> class.
        /// </summary>
        ...
        /// <param name="deliveryZone">Updated Delivery Zone.</param>
        ...
        public DeliveryZoneUpdatedEvent(string eventName = default(string), int? storeId = default(int?), int? storeGroupId = default(int?), UserEventInfo user = default(UserEventInfo), string description = default(string), DeliveryZone deliveryZone = default(DeliveryZone), Guid? flipdishEventId = default(Guid?), DateTime? createTime = default(DateTime?), int? position = default(int?), string appId = default(string), string orgId = default(string), string ipAddress = default(string), string activityId = default(string), string activityType = default(string))
        {
        ...
        /// </summary>
        /// <value>Updated Delivery Zone</value>
        ...
        {
            return this.Equals(input as DeliveryZoneUpdatedEvent);
        }

        /// <summary>
        /// Returns true if DeliveryZoneUpdatedEvent instances are equal
        /// </summary>
        /// <param name="input">Instance of DeliveryZoneUpdatedEvent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DeliveryZoneUpdatedEvent input)
        {
            if (input == null)
                return false;
