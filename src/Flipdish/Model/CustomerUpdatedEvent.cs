...
namespace Flipdish.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CustomerUpdatedEvent :  IEquatable<CustomerUpdatedEvent>
    {
        /// <summary>
        ...
        public CustomerUpdatedEvent(string eventName = default(string), UserEventInfo user = default(UserEventInfo), string description = default(string), Guid? flipdishEventId = default(Guid?), DateTime? createTime = default(DateTime?), int? position = default(int?), string appId = default(string), string orgId = default(string), string ipAddress = default(string), string activityId = default(string), string activityType = default(string))
        {
        ...
        {
            return this.Equals(input as CustomerUpdatedEvent);
        }

        /// <summary>
        /// Returns true if CustomerUpdatedEvent instances are equal
        /// </summary>
        /// <param name="input">Instance of CustomerUpdatedEvent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CustomerUpdatedEvent input)
        {
            if (input == null)
                return false;
