...
namespace Flipdish.Model
{
    ...
    public partial class CustomerUpdatedEvent :  IEquatable<CustomerUpdatedEvent>, IValidatableObject
    {
        ...
        public CustomerUpdatedEvent(string eventName = default(string), UserEventInfo user = default(UserEventInfo), string description = default(string), Guid? flipdishEventId = default(Guid?), DateTime? createTime = default(DateTime?), int? position = default(int?), string appId = default(string))
        {
