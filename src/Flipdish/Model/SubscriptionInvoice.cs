...
namespace Flipdish.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SubscriptionInvoice :  IEquatable<SubscriptionInvoice>
    {
        /// <summary>
        /// Currency
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SubscriptionInvoice" /> class.
        /// </summary>
        ...
        /// Initializes a new instance of the <see cref="SubscriptionInvoice" /> class.
        /// </summary>
        /// <param name="invoiceId">The invoice identifier (required).</param>
        /// <param name="number">Invoice number (required).</param>
        ...
        public SubscriptionInvoice(string invoiceId = default(string), string number = default(string), double? total = default(double?), CurrencyEnum currency = default(CurrencyEnum), StatusEnum status = default(StatusEnum), string subscriptionId = default(string), DateTime? paidAt = default(DateTime?), DateTime? finalisedAt = default(DateTime?), string pdfLink = default(string), string hostedUrl = default(string), bool? overdue = default(bool?))
        {
            ...
            if (number == null)
            {
                throw new InvalidDataException("number is a required property for SubscriptionInvoice and cannot be null");
            }
            else
            {
                this.Number = number;
            ...
            if (currency == null)
            {
                throw new InvalidDataException("currency is a required property for SubscriptionInvoice and cannot be null");
            }
            else
            {
            ...
            if (status == null)
            {
                throw new InvalidDataException("status is a required property for SubscriptionInvoice and cannot be null");
            }
            else
            {
                this.Status = status;
            }
            // to ensure "pdfLink" is required (not null)
            if (pdfLink == null)
            {
                throw new InvalidDataException("pdfLink is a required property for SubscriptionInvoice and cannot be null");
            }
            else
            {
            ...
            if (hostedUrl == null)
            {
                throw new InvalidDataException("hostedUrl is a required property for SubscriptionInvoice and cannot be null");
            }
            else
            {
            ...
            if (overdue == null)
            {
                throw new InvalidDataException("overdue is a required property for SubscriptionInvoice and cannot be null");
            }
            else
            {
        ...
        [DataMember(Name="PdfLink", EmitDefaultValue=false)]
        ...
        {
            return this.Equals(input as SubscriptionInvoice);
        }

        /// <summary>
        /// Returns true if SubscriptionInvoice instances are equal
        /// </summary>
        /// <param name="input">Instance of SubscriptionInvoice to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SubscriptionInvoice input)
        {
            if (input == null)
                return false;
