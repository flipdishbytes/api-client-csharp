...
{
    /// <summary>
    /// FlipdishPublicModelsV1MenusMenuItemOptionSetItem
    /// </summary>
    [DataContract]
    public partial class FlipdishPublicModelsV1MenusMenuItemOptionSetItem :  IEquatable<FlipdishPublicModelsV1MenusMenuItemOptionSetItem>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="FlipdishPublicModelsV1MenusMenuItemOptionSetItem" /> class.
        /// </summary>
        ...
        public FlipdishPublicModelsV1MenusMenuItemOptionSetItem(int? MenuItemOptionSetItemId = default(int?), string ImageUrl = default(string), string Name = default(string), double? Price = default(double?), bool? IsAvailable = default(bool?), int? DisplayOrder = default(int?), CellLayoutTypeEnum? CellLayoutType = default(CellLayoutTypeEnum?))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class FlipdishPublicModelsV1MenusMenuItemOptionSetItem {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as FlipdishPublicModelsV1MenusMenuItemOptionSetItem);
        }

        /// <summary>
        /// Returns true if FlipdishPublicModelsV1MenusMenuItemOptionSetItem instances are equal
        /// </summary>
        /// <param name="other">Instance of FlipdishPublicModelsV1MenusMenuItemOptionSetItem to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FlipdishPublicModelsV1MenusMenuItemOptionSetItem other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
