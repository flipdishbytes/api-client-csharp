...
namespace Flipdish.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PayoutSummary :  IEquatable<PayoutSummary>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PayoutSummary" /> class.
        /// </summary>
        /// <param name="payoutStatus">Status of the payout.</param>
        /// <param name="totalAmount">Total payouts amount.</param>
        /// <param name="currency">Payout currency.</param>
        /// <param name="totalCount">Total payouts count.</param>
        public PayoutSummary(PayoutStatusEnum? payoutStatus = default(PayoutStatusEnum?), double? totalAmount = default(double?), CurrencyEnum? currency = default(CurrencyEnum?), int? totalCount = default(int?))
        {
        ...
        /// </summary>
        /// <value>Total payouts amount</value>
        ...
        /// Total payouts count
        /// </summary>
        /// <value>Total payouts count</value>
        ...
        {
            return this.Equals(input as PayoutSummary);
        }

        /// <summary>
        /// Returns true if PayoutSummary instances are equal
        /// </summary>
        /// <param name="input">Instance of PayoutSummary to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PayoutSummary input)
        {
            if (input == null)
                return false;
