...
{
    /// <summary>
    /// FlipdishPublicModelsV1FeesFeeSummary
    /// </summary>
    [DataContract]
    public partial class FlipdishPublicModelsV1FeesFeeSummary :  IEquatable<FlipdishPublicModelsV1FeesFeeSummary>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FlipdishPublicModelsV1FeesFeeSummary" /> class.
        /// </summary>
        ...
        public FlipdishPublicModelsV1FeesFeeSummary(double? FeeAmount = default(double?), double? PercentageRate = default(double?), double? PerTransactionFee = default(double?))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class FlipdishPublicModelsV1FeesFeeSummary {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as FlipdishPublicModelsV1FeesFeeSummary);
        }

        /// <summary>
        /// Returns true if FlipdishPublicModelsV1FeesFeeSummary instances are equal
        /// </summary>
        /// <param name="other">Instance of FlipdishPublicModelsV1FeesFeeSummary to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FlipdishPublicModelsV1FeesFeeSummary other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
