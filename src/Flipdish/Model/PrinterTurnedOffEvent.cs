...
namespace Flipdish.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PrinterTurnedOffEvent :  IEquatable<PrinterTurnedOffEvent>, IValidatableObject
    {
        /// <summary>
        ...
        public PrinterTurnedOffEvent(string eventName = default(string), string description = default(string), int? storeId = default(int?), UserEventInfo user = default(UserEventInfo), Printer printer = default(Printer), Guid? flipdishEventId = default(Guid?), DateTime? createTime = default(DateTime?), int? position = default(int?), string appId = default(string))
        {
        ...
        {
            return this.Equals(input as PrinterTurnedOffEvent);
        }

        /// <summary>
        /// Returns true if PrinterTurnedOffEvent instances are equal
        /// </summary>
        /// <param name="input">Instance of PrinterTurnedOffEvent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PrinterTurnedOffEvent input)
        {
            if (input == null)
                return false;
