...
namespace Flipdish.Model
{
    ...
    public partial class PrinterTurnedOffEvent :  IEquatable<PrinterTurnedOffEvent>, IValidatableObject
    {
        ...
        public PrinterTurnedOffEvent(string EventName = default(string), string Description = default(string), int? StoreId = default(int?), Printer Printer = default(Printer), Guid? FlipdishEventId = default(Guid?), DateTime? CreateTime = default(DateTime?), int? Position = default(int?))
        {
