...
{
    /// <summary>
    /// FlipdishPublicModelsV1MenusMenuSectionItemBase
    /// </summary>
    [DataContract]
    public partial class FlipdishPublicModelsV1MenusMenuSectionItemBase :  IEquatable<FlipdishPublicModelsV1MenusMenuSectionItemBase>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="FlipdishPublicModelsV1MenusMenuSectionItemBase" /> class.
        /// </summary>
        ...
        public FlipdishPublicModelsV1MenusMenuSectionItemBase(string Name = default(string), string Description = default(string), SpicinessRatingEnum? SpicinessRating = default(SpicinessRatingEnum?), double? Price = default(double?), int? DisplayOrder = default(int?), bool? Alcohol = default(bool?), bool? IsAvailable = default(bool?))
        {
            this.Name = Name;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class FlipdishPublicModelsV1MenusMenuSectionItemBase {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as FlipdishPublicModelsV1MenusMenuSectionItemBase);
        }

        /// <summary>
        /// Returns true if FlipdishPublicModelsV1MenusMenuSectionItemBase instances are equal
        /// </summary>
        /// <param name="other">Instance of FlipdishPublicModelsV1MenusMenuSectionItemBase to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FlipdishPublicModelsV1MenusMenuSectionItemBase other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
