...
{
    /// <summary>
    /// FlipdishPublicModelsV1StoresStore
    /// </summary>
    [DataContract]
    public partial class FlipdishPublicModelsV1StoresStore :  IEquatable<FlipdishPublicModelsV1StoresStore>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="FlipdishPublicModelsV1StoresStore" /> class.
        /// </summary>
        ...
        public FlipdishPublicModelsV1StoresStore(int? StoreId = default(int?), string Name = default(string), string ApmPhoneNumber = default(string), string PhoneNumber = default(string), string EmailAddress = default(string), FlipdishPublicModelsV1StoresStoreAddress Address = default(FlipdishPublicModelsV1StoresStoreAddress), bool? PreOrderEnabled = default(bool?), bool? TakeOutEnabled = default(bool?), bool? TableServiceEnabled = default(bool?), bool? DineInEnabled = default(bool?), bool? AllowPreOrdersAndTableService = default(bool?), bool? PickupEnabled = default(bool?), bool? DeliveryEnabled = default(bool?), bool? CardOrderDeliveryEnabled = default(bool?), bool? CashOrdersDeliveryEnabled = default(bool?), bool? CardOrdersPickupEnabled = default(bool?), bool? CashOrdersPickupEnabled = default(bool?), bool? TipsEnabled = default(bool?), bool? AutomaticallyAcceptOrders = default(bool?), bool? OpenForDelivery = default(bool?), bool? OpenForPickup = default(bool?), double? MinimumPickupOrderAmount = default(double?), List<FlipdishPublicModelsV1StoresDeliveryFeeArea> DeliveryFeeAreas = default(List<FlipdishPublicModelsV1StoresDeliveryFeeArea>), bool? RequireCustomerNameForPickup = default(bool?), bool? RequireCustomerNameForDelivery = default(bool?), List<FlipdishPublicModelsV1BusinessHoursPeriod> PickupHours = default(List<FlipdishPublicModelsV1BusinessHoursPeriod>), List<FlipdishPublicModelsV1BusinessHoursPeriod> DeliveryHours = default(List<FlipdishPublicModelsV1BusinessHoursPeriod>), string MicrosoftTimeZone = default(string), string IanaTimeZone = default(string), int? MenuId = default(int?), string OrderConfirmationMessageOverrideDelivery = default(string), string OrderConfirmationMessageOverridePickup = default(string), PrintoutLayoutTypeEnum? PrintoutLayoutType = default(PrintoutLayoutTypeEnum?), List<FlipdishPublicModelsV1StoresStoreNote> StoreNotes = default(List<FlipdishPublicModelsV1StoresStoreNote>))
        {
        ...
        public FlipdishPublicModelsV1StoresStoreAddress Address { get; set; }
        ...
        public List<FlipdishPublicModelsV1StoresDeliveryFeeArea> DeliveryFeeAreas { get; set; }
        ...
        public List<FlipdishPublicModelsV1BusinessHoursPeriod> PickupHours { get; set; }

        /// <summary>
        /// Gets or Sets DeliveryHours
        /// </summary>
        [DataMember(Name="deliveryHours", EmitDefaultValue=false)]
        public List<FlipdishPublicModelsV1BusinessHoursPeriod> DeliveryHours { get; set; }
        ...
        public List<FlipdishPublicModelsV1StoresStoreNote> StoreNotes { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class FlipdishPublicModelsV1StoresStore {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as FlipdishPublicModelsV1StoresStore);
        }

        /// <summary>
        /// Returns true if FlipdishPublicModelsV1StoresStore instances are equal
        /// </summary>
        /// <param name="other">Instance of FlipdishPublicModelsV1StoresStore to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FlipdishPublicModelsV1StoresStore other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
