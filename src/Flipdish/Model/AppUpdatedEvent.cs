...
namespace Flipdish.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AppUpdatedEvent :  IEquatable<AppUpdatedEvent>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AppUpdatedEvent" /> class.
        /// </summary>
        ...
        public AppUpdatedEvent(string eventName = default(string), string description = default(string), string changes = default(string), string appName = default(string), string countryId = default(string), UserEventInfo user = default(UserEventInfo), App app = default(App), string orgId = default(string), Guid? flipdishEventId = default(Guid?), DateTime? createTime = default(DateTime?), int? position = default(int?), string appId = default(string), string ipAddress = default(string), string activityId = default(string), string activityType = default(string))
        {
        ...
        /// </summary>
        /// <value>App - Whitelabel config</value>
        ...
        {
            return this.Equals(input as AppUpdatedEvent);
        }

        /// <summary>
        /// Returns true if AppUpdatedEvent instances are equal
        /// </summary>
        /// <param name="input">Instance of AppUpdatedEvent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AppUpdatedEvent input)
        {
            if (input == null)
                return false;
