...
namespace Flipdish.Model
{
    ...
    public partial class MenuSectionItemBase :  IEquatable<MenuSectionItemBase>, IValidatableObject
    {
        ...
        public MenuSectionItemBase(string Name = default(string), string Description = default(string), SpicinessRatingEnum? SpicinessRating = default(SpicinessRatingEnum?), double? Price = default(double?), double? ActualPrice = default(double?), int? DisplayOrder = default(int?), bool? Alcohol = default(bool?), bool? IsAvailable = default(bool?), string ImageUrl = default(string))
        {
            this.Name = Name;
