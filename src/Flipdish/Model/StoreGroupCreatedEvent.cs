...
namespace Flipdish.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class StoreGroupCreatedEvent :  IEquatable<StoreGroupCreatedEvent>, IValidatableObject
    {
        /// <summary>
        ...
        public StoreGroupCreatedEvent(int? storeGroupId = default(int?), UserEventInfo user = default(UserEventInfo), string description = default(string), StoreGroup storeGroup = default(StoreGroup), string eventName = default(string), Guid? flipdishEventId = default(Guid?), DateTime? createTime = default(DateTime?), int? position = default(int?), string appId = default(string))
        {
