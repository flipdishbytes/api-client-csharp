...
namespace Flipdish.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class StoreGroupCreatedEvent :  IEquatable<StoreGroupCreatedEvent>
    {
        /// <summary>
        ...
        public StoreGroupCreatedEvent(string eventName = default(string), int? storeGroupId = default(int?), UserEventInfo user = default(UserEventInfo), string description = default(string), StoreGroup storeGroup = default(StoreGroup), Guid? flipdishEventId = default(Guid?), DateTime? createTime = default(DateTime?), int? position = default(int?), string appId = default(string), string orgId = default(string), string ipAddress = default(string), string activityId = default(string), string activityType = default(string))
        {
        ...
        /// </summary>
        /// <value>User which created this store group</value>
        ...
        /// Created store group
        /// </summary>
        /// <value>Created store group</value>
        ...
        {
            return this.Equals(input as StoreGroupCreatedEvent);
        }

        /// <summary>
        /// Returns true if StoreGroupCreatedEvent instances are equal
        /// </summary>
        /// <param name="input">Instance of StoreGroupCreatedEvent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StoreGroupCreatedEvent input)
        {
            if (input == null)
                return false;
