...
namespace Flipdish.Model
{
    ...
    public partial class StoreGroupCreatedEvent :  IEquatable<StoreGroupCreatedEvent>
    {
        ...
        public StoreGroupCreatedEvent(string eventName = default(string), int? storeGroupId = default(int?), UserEventInfo user = default(UserEventInfo), string description = default(string), StoreGroup storeGroup = default(StoreGroup), Guid? flipdishEventId = default(Guid?), DateTime? createTime = default(DateTime?), int? position = default(int?), string appId = default(string), string orgId = default(string), string ipAddress = default(string))
        {
