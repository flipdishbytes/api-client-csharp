...
namespace Flipdish.Model
{
    ...
    public partial class OrderRatingUpdatedEvent :  IEquatable<OrderRatingUpdatedEvent>, IValidatableObject
    {
        ...
        public OrderRatingUpdatedEvent(string eventName = default(string), int? rating = default(int?), string description = default(string), Order order = default(Order), Guid? flipdishEventId = default(Guid?), DateTime? createTime = default(DateTime?), int? position = default(int?), string appId = default(string))
        {
