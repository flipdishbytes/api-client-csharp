...
namespace Flipdish.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OrderRatingUpdatedEvent :  IEquatable<OrderRatingUpdatedEvent>
    {
        /// <summary>
        ...
        public OrderRatingUpdatedEvent(string eventName = default(string), int? rating = default(int?), string description = default(string), Order order = default(Order), Guid? flipdishEventId = default(Guid?), DateTime? createTime = default(DateTime?), int? position = default(int?), string appId = default(string), string orgId = default(string), string ipAddress = default(string), string activityId = default(string), string activityType = default(string))
        {
