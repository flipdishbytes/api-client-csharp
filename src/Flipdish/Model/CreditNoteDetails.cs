...
namespace Flipdish.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CreditNoteDetails :  IEquatable<CreditNoteDetails>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreditNoteDetails" /> class.
        /// </summary>
        /// <param name="remainingCredit">Remaining credit.</param>
        public CreditNoteDetails(double? remainingCredit = default(double?))
        {
