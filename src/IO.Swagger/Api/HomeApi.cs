...
namespace IO.Swagger.Api
{
    ...
    public partial class HomeApi : IHomeApi
    {
        ...
        /// <exception cref="IO.Swagger.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>Object</returns>
        public Object DismissOldPortalAction ()
        {
             ApiResponse<Object> localVarResponse = DismissOldPortalActionWithHttpInfo();
             return localVarResponse.Data;
        }
        ...
        public ApiResponse< Object > DismissOldPortalActionWithHttpInfo ()
        {
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("DismissOldPortalAction", localVarResponse);
                if (exception != null) throw exception;
            }
        ...
        /// <exception cref="IO.Swagger.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>Task of Object</returns>
        public async System.Threading.Tasks.Task<Object> DismissOldPortalActionAsync ()
        {
             ApiResponse<Object> localVarResponse = await DismissOldPortalActionAsyncWithHttpInfo();
             return localVarResponse.Data;
