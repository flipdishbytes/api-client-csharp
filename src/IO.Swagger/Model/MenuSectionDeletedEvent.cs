...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class MenuSectionDeletedEvent :  IEquatable<MenuSectionDeletedEvent>, IValidatableObject
    {
        /// <summary>
        ...
        public MenuSectionDeletedEvent(int? menuId = default(int?), string description = default(string), UserEventInfo user = default(UserEventInfo), MenuSection menuSection = default(MenuSection), string eventName = default(string), Guid? flipdishEventId = default(Guid?), DateTime? createTime = default(DateTime?), int? position = default(int?), string appId = default(string), string ipAddress = default(string))
        {
            this.MenuId = menuId;
