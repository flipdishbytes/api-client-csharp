...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class StoreGroupExtended :  IEquatable<StoreGroupExtended>, IValidatableObject
    {
        /// <summary>
        /// Currency used by the stores in this group
        /// </summary>
        /// <value>Currency used by the stores in this group</value>
        ...
        /// </summary>
        /// <value>Total Amount of Stores</value>
        [DataMember(Name="TotalStores", EmitDefaultValue=false)]
        ...
        /// </summary>
        /// <value>Store Headers associated with Store Group</value>
        [DataMember(Name="StoreHeaders", EmitDefaultValue=false)]
        public List<StoreHeader> StoreHeaders { get; set; }

        /// <summary>
        /// Unique Store Group Identifier
        /// </summary>
        /// <value>Unique Store Group Identifier</value>
        ...
        /// Store Group rating
        /// </summary>
        /// <value>Store Group rating</value>
        [DataMember(Name="GeneralRating", EmitDefaultValue=false)]
        public double? GeneralRating { get; set; }

        /// <summary>
        /// Store Group rating count
        /// </summary>
        /// <value>Store Group rating count</value>
        [DataMember(Name="GeneralRatingCount", EmitDefaultValue=false)]
        ...
        {
            return this.Equals(input as StoreGroupExtended);
        }

        /// <summary>
        /// Returns true if StoreGroupExtended instances are equal
        /// </summary>
        /// <param name="input">Instance of StoreGroupExtended to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StoreGroupExtended input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.GroupedCoordinates == input.GroupedCoordinates ||
                    this.GroupedCoordinates != null &&
                    this.GroupedCoordinates.SequenceEqual(input.GroupedCoordinates)
                ) && 
                (
                    this.StoreHeaders == input.StoreHeaders ||
                    this.StoreHeaders != null &&
                    this.StoreHeaders.SequenceEqual(input.StoreHeaders)
                ) && 
                (
                ...
                (
                    this.GeneralRating == input.GeneralRating ||
                    (this.GeneralRating != null &&
                    this.GeneralRating.Equals(input.GeneralRating))
                ) && 
                (
                    this.GeneralRatingCount == input.GeneralRatingCount ||
                    (this.GeneralRatingCount != null &&
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.StoreHeaders != null)
                    hashCode = hashCode * 59 + this.StoreHeaders.GetHashCode();
