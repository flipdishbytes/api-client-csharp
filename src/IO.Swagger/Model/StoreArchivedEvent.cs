...
namespace IO.Swagger.Model
{
    ...
    public partial class StoreArchivedEvent :  IEquatable<StoreArchivedEvent>, IValidatableObject
    {
        ...
        /// </summary>
        /// <value>User which archived this store</value>
        ...
        {
            return this.Equals(input as StoreArchivedEvent);
        }

        /// <summary>
        /// Returns true if StoreArchivedEvent instances are equal
        /// </summary>
        /// <param name="input">Instance of StoreArchivedEvent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StoreArchivedEvent input)
        {
            if (input == null)
                return false;
