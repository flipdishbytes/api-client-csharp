...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AppStoreConfigCreatedEvent :  IEquatable<AppStoreConfigCreatedEvent>, IValidatableObject
    {
        /// <summary>
        ...
        public AppStoreConfigCreatedEvent(string eventName = default(string), string appStoreAppId = default(string), string appStoreAppConfigurationId = default(string), Guid? flipdishEventId = default(Guid?), DateTime? createTime = default(DateTime?), int? position = default(int?), string appId = default(string), string ipAddress = default(string))
        {
