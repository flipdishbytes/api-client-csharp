...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class EmvNotificationEvent :  IEquatable<EmvNotificationEvent>, IValidatableObject
    {
        /// <summary>
