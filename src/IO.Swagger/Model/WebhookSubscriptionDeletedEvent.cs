...
namespace IO.Swagger.Model
{
    ...
    public partial class WebhookSubscriptionDeletedEvent :  IEquatable<WebhookSubscriptionDeletedEvent>, IValidatableObject
    {
        ...
        public WebhookSubscriptionDeletedEvent(string eventName = default(string), WebhookSubscriptionEventInfo webhookSubscriptionEventInfo = default(WebhookSubscriptionEventInfo), Guid? flipdishEventId = default(Guid?), DateTime? createTime = default(DateTime?), int? position = default(int?), string appId = default(string), string ipAddress = default(string))
        {
