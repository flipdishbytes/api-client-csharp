...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class StoreOrderCapacityConfigEditModel :  IEquatable<StoreOrderCapacityConfigEditModel>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="StoreOrderCapacityConfigEditModel" /> class.
        /// </summary>
        /// <param name="orderCapacityPeriods">Order capacity periods.</param>
        public StoreOrderCapacityConfigEditModel(List<StoreOrderCapacityPeriod> orderCapacityPeriods = default(List<StoreOrderCapacityPeriod>))
        {
        ...
        {
            return this.Equals(input as StoreOrderCapacityConfigEditModel);
        }

        /// <summary>
        /// Returns true if StoreOrderCapacityConfigEditModel instances are equal
        /// </summary>
        /// <param name="input">Instance of StoreOrderCapacityConfigEditModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StoreOrderCapacityConfigEditModel input)
        {
            if (input == null)
                return false;
