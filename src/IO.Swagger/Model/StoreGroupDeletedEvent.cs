...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class StoreGroupDeletedEvent :  IEquatable<StoreGroupDeletedEvent>, IValidatableObject
    {
        /// <summary>
        ...
        public StoreGroupDeletedEvent(string eventName = default(string), int? storeGroupId = default(int?), UserEventInfo user = default(UserEventInfo), string description = default(string), StoreGroup storeGroup = default(StoreGroup), Guid? flipdishEventId = default(Guid?), DateTime? createTime = default(DateTime?), int? position = default(int?), string appId = default(string), string ipAddress = default(string))
        {
