...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class StoreServiceChargeUpdatedEvent :  IEquatable<StoreServiceChargeUpdatedEvent>, IValidatableObject
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>Service Charge Configuration</value>
        ...
        {
            return this.Equals(input as StoreServiceChargeUpdatedEvent);
        }

        /// <summary>
        /// Returns true if StoreServiceChargeUpdatedEvent instances are equal
        /// </summary>
        /// <param name="input">Instance of StoreServiceChargeUpdatedEvent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StoreServiceChargeUpdatedEvent input)
        {
            if (input == null)
                return false;
