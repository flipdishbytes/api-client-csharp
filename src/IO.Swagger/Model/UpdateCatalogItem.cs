...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class UpdateCatalogItem :  IEquatable<UpdateCatalogItem>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateCatalogItem" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as UpdateCatalogItem);
        }

        /// <summary>
        /// Returns true if UpdateCatalogItem instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdateCatalogItem to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdateCatalogItem input)
        {
            if (input == null)
                return false;
