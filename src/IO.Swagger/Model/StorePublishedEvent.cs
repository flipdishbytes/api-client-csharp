...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class StorePublishedEvent :  IEquatable<StorePublishedEvent>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="StorePublishedEvent" /> class.
        /// </summary>
        /// <param name="eventName">The event name.</param>
        /// <param name="storeId">Store Id.</param>
        /// <param name="user">User which published this store.</param>
        /// <param name="description">Description.</param>
        /// <param name="store">Published Store.</param>
        /// <param name="flipdishEventId">The identitfier of the event.</param>
        /// <param name="createTime">The time of creation of the event.</param>
        /// <param name="position">Position.</param>
        /// <param name="appId">App id.</param>
        /// <param name="ipAddress">Ip Address.</param>
        public StorePublishedEvent(string eventName = default(string), int? storeId = default(int?), UserEventInfo user = default(UserEventInfo), string description = default(string), Store store = default(Store), Guid? flipdishEventId = default(Guid?), DateTime? createTime = default(DateTime?), int? position = default(int?), string appId = default(string), string ipAddress = default(string))
        {
        ...
        /// </summary>
        /// <value>User which published this store</value>
        ...
        {
            return this.Equals(input as StorePublishedEvent);
        }

        /// <summary>
        /// Returns true if StorePublishedEvent instances are equal
        /// </summary>
        /// <param name="input">Instance of StorePublishedEvent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StorePublishedEvent input)
        {
            if (input == null)
                return false;
