...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TeammateInviteAcceptedEvent :  IEquatable<TeammateInviteAcceptedEvent>, IValidatableObject
    {
        /// <summary>
        ...
        public TeammateInviteAcceptedEvent(Teammate teammate = default(Teammate), UserEventInfo user = default(UserEventInfo), string eventName = default(string), Guid? flipdishEventId = default(Guid?), DateTime? createTime = default(DateTime?), int? position = default(int?), string appId = default(string), string ipAddress = default(string))
        {
