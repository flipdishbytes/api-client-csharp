...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CatalogItemArchivedEvent :  IEquatable<CatalogItemArchivedEvent>, IValidatableObject
    {
        /// <summary>
        ...
        public CatalogItemArchivedEvent(string eventName = default(string), string description = default(string), UserEventInfo user = default(UserEventInfo), CatalogItem catalogItem = default(CatalogItem), Guid? flipdishEventId = default(Guid?), DateTime? createTime = default(DateTime?), int? position = default(int?), string appId = default(string), string ipAddress = default(string))
        {
