...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AppStoreConfigUpdatedEvent :  IEquatable<AppStoreConfigUpdatedEvent>, IValidatableObject
    {
        /// <summary>
        ...
        public AppStoreConfigUpdatedEvent(string eventName = default(string), string appStoreAppId = default(string), UpdateAppStoreAppConfigurationWebhookDTO appStoreAppConfiguration = default(UpdateAppStoreAppConfigurationWebhookDTO), Guid? flipdishEventId = default(Guid?), DateTime? createTime = default(DateTime?), int? position = default(int?), string appId = default(string), string ipAddress = default(string))
        {
