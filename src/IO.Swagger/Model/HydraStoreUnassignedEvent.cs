...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class HydraStoreUnassignedEvent :  IEquatable<HydraStoreUnassignedEvent>, IValidatableObject
    {
        /// <summary>
        ...
        public HydraStoreUnassignedEvent(UserEventInfo user = default(UserEventInfo), List<int?> storeIds = default(List<int?>), string eventName = default(string), Guid? flipdishEventId = default(Guid?), DateTime? createTime = default(DateTime?), int? position = default(int?), string appId = default(string))
        {
            this.User = user;
