...
namespace Example
{
    public class AuthorizeStripeTerminal_0Example
    {
        public void main()
        {
            // Configure OAuth2 access token for authorization: oauth2
            ...
            {
                Debug.Print("Exception when calling CardReadersApi.AuthorizeStripeTerminal_0: " + e.Message );
            }
        }
    }
}
...
namespace Example
{
    public class InitiateKioskUpdateInstallForBluetoothTerminalExample
    {
        public void main()
        {
            // Configure OAuth2 access token for authorization: oauth2
            ...
            {
                Debug.Print("Exception when calling CardReadersApi.InitiateKioskUpdateInstallForBluetoothTerminal: " + e.Message );
            }
        }
    }
}
