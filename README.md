...
*CardReadersApi* | [**InitiateKioskUpdateInstallForBluetoothTerminal**](docs/CardReadersApi.md#initiatekioskupdateinstallforbluetoothterminal) | **POST** /api/v1.0/{appId}/cardreaders/kiosk/{deviceId}/bluetooth/{terminalType}/installUpdate | Initiate Kiosk Update Install for bluetooth terminal
